...
/**
 * Manifests vendored into this app's `public/demo-manifests`, for shapes the
 * Cookbook does not publish an example of.
 */
export const LOCAL_MANIFESTS: ManifestEntry[] = [
    {
        label: 'Multi-Target Annotation Array',
        url: `${import.meta.env.BASE_URL}demo-manifests/multi-target-array/manifest.json`,
    },
];
