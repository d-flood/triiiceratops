...
function getThumbnailServiceUrl(service, size) {
    let profile = '';
    try {
...
export function resolveThumbnailResourceSrc(thumbnail, size = 200) {
    if (!thumbnail)
        return '';
 ...
 */
export function getThumbnailSrc(canvas, size = 200) {
    let src = '';
