...
const en_viewer_variant_tooltip_full = /** @type {(inputs: {}) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Example with plugins`)
};

const de_viewer_variant_tooltip_full = /** @type {(inputs: {}) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Beispiel mit Plugins`)
};
