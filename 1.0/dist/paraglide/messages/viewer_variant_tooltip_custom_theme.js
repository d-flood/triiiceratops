...
const en_viewer_variant_tooltip_custom_theme = /** @type {(inputs: {}) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Example with custom theme override`)
};

const de_viewer_variant_tooltip_custom_theme = /** @type {(inputs: {}) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Beispiel mit benutzerdefiniertem Thema`)
};
