 ...
 */
export function getGalleryThumbItemHeight(size) {
    return Math.max(MIN_FRAME + ITEM_CHROME_H, size - TRACK_PAD * 2 - BAND_SLACK);
}
/**
 ...
 */
export function getGalleryThumbFrameHeight(size) {
 ...
 */
export function getGalleryThumbItemWidth(size) {
 ...
 */
export function getGalleryThumbFrameWidth(size) {
