function De(ne, F) {
  for (var e = 0; e < F.length; e++) {
    ...
    if (typeof t != "string" && !Array.isArray(t)) {
      for (const r in t)
        if (r !== "default" && !(r in ne)) {
          const i = Object.getOwnPropertyDescriptor(t, r);
          i && Object.defineProperty(ne, r, i.get ? i : {
            enumerable: !0,
            get: () => t[r]
          });
        }
...
var ye = { exports: {} }, Be = ye.exports, Ce;
function Oe() {
  return Ce || (Ce = 1, (function(ne) {
    ...
    (function(e) {
      ...
      e.isFunction = function(n) {
        ...
        if (!n || F.type(n) !== "object" || n.nodeType || e.isWindow(n) || n.constructor && !i.call(n, "constructor") && !i.call(n.constructor.prototype, "isPrototypeOf"))
          return !1;
        var a;
        for (var s in n)
          a = s;
        return a === void 0 || i.call(n, a);
        ...
        if (e.supportsCanvas) {
          var n = document.createElement("canvas").getContext("2d"), a = window.devicePixelRatio || 1, s = n.webkitBackingStorePixelRatio || n.mozBackingStorePixelRatio || n.msBackingStorePixelRatio || n.oBackingStorePixelRatio || n.backingStorePixelRatio || 1;
          return Math.max(a, 1) / s;
        } else
          return 1;
      }, e.pixelDensityRatio = e.getCurrentPixelDensityRatio();
    })(F), (function(e) {
      e.extend = function() {
        var s, o, l, u, p, m, w = arguments[0] || {}, y = arguments.length, T = !1, x = 1;
        for (typeof w == "boolean" && (T = w, w = arguments[1] || {}, x = 2), typeof w != "object" && !F.isFunction(w) && (w = {}), y === x && (w = this, --x); x < y; x++)
          if (s = arguments[x], s !== null || s !== void 0)
            for (o in s) {
              var E = Object.getOwnPropertyDescriptor(s, o);
              if (E !== void 0) {
                if (E.get || E.set) {
                  Object.defineProperty(w, o, E);
                  continue;
                }
                u = E.value;
              } else {
              ...
              w !== u && (T && u && (F.isPlainObject(u) || (p = F.isArray(u))) ? (l = w[o], p ? (p = !1, m = l && F.isArray(l) ? l : []) : m = l && F.isPlainObject(l) ? l : {}, w[o] = F.extend(T, m, u)) : u !== void 0 && (w[o] = u));
            }
        return w;
      };
      var t = function() {
      ...
      e.extend(
        ...
        /** @lends OpenSeadragon */
        {
           ...
           * @returns {Function}
           */
          delegate: function(s, o) {
            return function() {
              var l = arguments;
              return l === void 0 && (l = []), o.apply(s, l);
            };
          },
          /**
          ...
          getElementPosition: function(s) {
            var o = new e.Point(), l, u;
            for (s = e.getElement(s), l = e.getElementStyle(s).position === "fixed", u = a(s, l); u; )
              o.x += s.offsetLeft, o.y += s.offsetTop, l && (o = o.plus(e.getPageScroll())), s = u, l = e.getElementStyle(s).position === "fixed", u = a(s, l);
            return o;
          },
          /**
          ...
          getElementOffset: function(s) {
            s = e.getElement(s);
            var o = s && s.ownerDocument, l, u, p = { top: 0, left: 0 };
            return o ? (l = o.documentElement, typeof s.getBoundingClientRect < "u" && (p = s.getBoundingClientRect()), u = o === o.window ? o : o.nodeType === 9 ? o.defaultView || o.parentWindow : !1, new e.Point(
              p.left + (u.pageXOffset || l.scrollLeft) - (l.clientLeft || 0),
              p.top + (u.pageYOffset || l.scrollTop) - (l.clientTop || 0)
            )) : new e.Point();
          },
          /**
          ...
          getCssPropertyWithVendorPrefix: function(s) {
            ...
            return e.getCssPropertyWithVendorPrefix = function(l) {
              if (o[l] !== void 0)
                return o[l];
              var u = document.createElement("div").style, p = null;
              if (u[l] !== void 0)
                p = l;
              else
                for (var m = [
                  ...
                  "ms",
                  "o"
                ], w = e.capitalizeFirstLetter(l), y = 0; y < m.length; y++) {
                  var T = m[y] + w;
                  if (u[T] !== void 0) {
                    p = T;
                    break;
           ...
           * @returns {Boolean}
           */
          pointInElement: function(s, o) {
            s = e.getElement(s);
            var l = e.getElementOffset(s), u = e.getElementSize(s);
            return o.x >= l.x && o.x < l.x + u.x && o.y < l.y + u.y && o.y >= l.y;
          },
          /**
          ...
          getMousePosition: function(s) {
            if (typeof s.pageX == "number")
              e.getMousePosition = function(o) {
                var l = new e.Point();
                return l.x = o.pageX, l.y = o.pageY, l;
              };
            else if (typeof s.clientX == "number")
              e.getMousePosition = function(o) {
                var l = new e.Point();
                return l.x = o.clientX + document.body.scrollLeft + document.documentElement.scrollLeft, l.y = o.clientY + document.body.scrollTop + document.documentElement.scrollTop, l;
              };
            else
              throw new Error(
          ...
          setPageScroll: function(s) {
            if (typeof window.scrollTo < "u")
              e.setPageScroll = function(u) {
                window.scrollTo(u.x, u.y);
              };
            else {
              var o = e.getPageScroll();
              if (o.x === s.x && o.y === s.y)
                return;
              ...
              if (l.x !== o.x && l.y !== o.y) {
                e.setPageScroll = function(u) {
                  document.body.scrollLeft = u.x, document.body.scrollTop = u.y;
                };
                return;
              }
              if (document.documentElement.scrollLeft = s.x, document.documentElement.scrollTop = s.y, l = e.getPageScroll(), l.x !== o.x && l.y !== o.y) {
                e.setPageScroll = function(u) {
                  document.documentElement.scrollLeft = u.x, document.documentElement.scrollTop = u.y;
                };
                return;
              }
              e.setPageScroll = function(u) {
          ...
          makeCenteredNode: function(s) {
            ...
            return e.extend(o[0].style, {
              ...
              textAlign: "center"
            }), o[0].appendChild(o[1]), o[1].appendChild(o[2]), o[2].appendChild(s), o[0];
          },
          /**
          ...
          makeNeutralElement: function(s) {
            var o = document.createElement(s), l = o.style;
            return l.background = "transparent none", l.border = "none", l.margin = "0px", l.padding = "0px", l.position = "static", o;
          },
          /**
          ...
          makeTransparentImage: function(s) {
            var o = e.makeNeutralElement("img");
            return o.src = s, o;
          },
          /**
           ...
           */
          setElementOpacity: function(s, o, l) {
            var u, p;
            s = e.getElement(s), l && !e.Browser.alpha && (o = Math.round(o)), e.Browser.opacity ? s.style.opacity = o < 1 ? o : "" : o < 1 ? (u = Math.round(100 * o), p = "alpha(opacity=" + u + ")", s.style.filter = p) : s.style.filter = "";
          },
          /**
           ...
           * @param {String} value
           */
          setElementPointerEvents: function(s, o) {
            s = e.getElement(s), typeof s.style < "u" && typeof s.style.pointerEvents < "u" && (s.style.pointerEvents = o);
          },
          /**
          ...
          addClass: function(s, o) {
            s = e.getElement(s), s.className ? (" " + s.className + " ").indexOf(" " + o + " ") === -1 && (s.className += " " + o) : s.className = o;
          },
          /**
           ...
           */
          indexOf: function(s, o, l) {
            return Array.prototype.indexOf ? this.indexOf = function(u, p, m) {
              return u.indexOf(p, m);
            } : this.indexOf = function(u, p, m) {
              var w, y = m || 0, T;
              if (!u)
                throw new TypeError();
              if (T = u.length, T === 0 || y >= T)
                return -1;
              for (y < 0 && (y = T - Math.abs(y)), w = y; w < T; w++)
                if (u[w] === p)
                  return w;
              return -1;
            }, this.indexOf(s, o, l);
           ...
           * @param {String} className
           */
          removeClass: function(s, o) {
            var l, u = [], p;
            for (s = e.getElement(s), l = s.className.split(/\s+/), p = 0; p < l.length; p++)
              l[p] && l[p] !== o && u.push(l[p]);
            s.className = u.join(" ");
          },
          /**
          ...
          normalizeEventListenerOptions: function(s) {
            var o;
            return typeof s < "u" ? typeof s == "boolean" ? o = e.supportsEventListenerOptions ? { capture: s } : s : o = e.supportsEventListenerOptions ? s : typeof s.capture < "u" ? s.capture : !1 : o = e.supportsEventListenerOptions ? { capture: !1 } : !1, o;
          },
          /**
          ...
          addEvent: (function() {
            if (e.supportsAddEventListener)
              return function(s, o, l, u) {
                u = e.normalizeEventListenerOptions(u), s = e.getElement(s), s.addEventListener(o, l, u);
              };
            if (document.documentElement.attachEvent && document.attachEvent)
              return function(s, o, l) {
                s = e.getElement(s), s.attachEvent("on" + o, l);
              };
          ...
          removeEvent: (function() {
            if (e.supportsRemoveEventListener)
              return function(s, o, l, u) {
                u = e.normalizeEventListenerOptions(u), s = e.getElement(s), s.removeEventListener(o, l, u);
              };
            if (document.documentElement.detachEvent && document.detachEvent)
              return function(s, o, l) {
                s = e.getElement(s), s.detachEvent("on" + o, l);
              };
            throw new Error("No known event model.");
          })(),
          /**
          ...
          getUrlProtocol: function(s) {
            var o = s.match(/^([a-z]+:)\/\//i);
            return o === null ? window.location.protocol : o[1].toLowerCase();
          },
          /**
           ...
           * @returns {XMLHttpRequest}
           */
          makeAjaxRequest: function(s, o, l) {
            var u, p, m, w;
            e.isPlainObject(s) && (o = s.success, l = s.error, u = s.withCredentials, p = s.headers, m = s.responseType || null, w = s.postData || null, s = s.url);
            var y = e.getUrlProtocol(s), T = e.createAjaxRequest();
            if (!e.isFunction(o))
              throw new Error("makeAjaxRequest requires a success callback");
            T.onreadystatechange = function() {
              T.readyState === 4 && (T.onreadystatechange = function() {
              }, T.status >= 200 && T.status < 300 || T.status === 0 && y !== "http:" && y !== "https:" ? o(T) : e.isFunction(l) ? l(T) : e.console.error("AJAX request returned %d: %s", T.status, s));
            };
            var x = w ? "POST" : "GET";
            try {
              if (T.open(x, s, !0), m && (T.responseType = m), p)
                for (var E in p)
                  Object.prototype.hasOwnProperty.call(p, E) && p[E] && T.setRequestHeader(E, p[E]);
              u && (T.withCredentials = !0), T.send(w);
            } catch (P) {
              e.console.error("%s while making AJAX request: %s", P.name, P.message), T.onreadystatechange = function() {
              }, e.isFunction(l) && l(T, P);
            }
            return T;
          },
          /**
           ...
           */
          jsonp: function(s) {
            var o, l = s.url, u = document.head || document.getElementsByTagName("head")[0] || document.documentElement, p = s.callbackName || "openseadragon" + e.now(), m = window[p], w = "$1" + p + "$2", y = s.param || "callback", T = s.callback;
            l = l.replace(/(=)\?(&|$)|\?\?/i, w), l += (/\?/.test(l) ? "&" : "?") + y + "=" + p, window[p] = function(x) {
              if (m)
                window[p] = m;
              else
                try {
            ...
            }, o = document.createElement("script"), (s.async !== void 0 || s.async !== !1) && (o.async = "async"), s.scriptCharset && (o.charset = s.scriptCharset), o.src = l, o.onload = o.onreadystatechange = function(x, E) {
              (E || !o.readyState || /loaded|complete/.test(o.readyState)) && (o.onload = o.onreadystatechange = null, u && o.parentNode && u.removeChild(o), o = void 0);
          ...
          parseXml: function(s) {
            if (window.DOMParser)
              e.parseXml = function(o) {
                var l = null, u;
                return u = new DOMParser(), l = u.parseFromString(o, "text/xml"), l;
              };
            else
      ...
      (function() {
        var s = navigator.appVersion, o = navigator.userAgent, l;
        switch (navigator.appName) {
          case "Microsoft Internet Explorer":
            window.attachEvent && window.ActiveXObject && (e.Browser.vendor = e.BROWSERS.IE, e.Browser.version = parseFloat(
              o.substring(
                o.indexOf("MSIE") + 5,
                o.indexOf(";", o.indexOf("MSIE"))
              )
            ));
            break;
          case "Netscape":
            window.addEventListener && (o.indexOf("Edge") >= 0 ? (e.Browser.vendor = e.BROWSERS.EDGE, e.Browser.version = parseFloat(
              o.substring(o.indexOf("Edge") + 5)
            )) : o.indexOf("Edg") >= 0 ? (e.Browser.vendor = e.BROWSERS.CHROMEEDGE, e.Browser.version = parseFloat(
              o.substring(o.indexOf("Edg") + 4)
            )) : o.indexOf("Firefox") >= 0 ? (e.Browser.vendor = e.BROWSERS.FIREFOX, e.Browser.version = parseFloat(
              o.substring(o.indexOf("Firefox") + 8)
            )) : o.indexOf("Safari") >= 0 ? (e.Browser.vendor = o.indexOf("Chrome") >= 0 ? e.BROWSERS.CHROME : e.BROWSERS.SAFARI, e.Browser.version = parseFloat(
              o.substring(
                o.substring(0, o.indexOf("Safari")).lastIndexOf("/") + 1,
                o.indexOf("Safari")
              )
            )) : (l = new RegExp("Trident/.*rv:([0-9]{1,}[.0-9]{0,})"), l.exec(o) !== null && (e.Browser.vendor = e.BROWSERS.IE, e.Browser.version = parseFloat(RegExp.$1))));
            break;
          case "Opera":
            e.Browser.vendor = e.BROWSERS.OPERA, e.Browser.version = parseFloat(s);
            break;
        }
        var u = window.location.search.substring(1), p = u.split("&"), m, w, y;
        for (y = 0; y < p.length; y++)
          if (m = p[y], w = m.indexOf("="), w > 0) {
            var T = m.substring(0, w), x = m.substring(w + 1);
            try {
              n[T] = decodeURIComponent(x);
            } catch {
        ...
        var o = s.requestAnimationFrame || s.mozRequestAnimationFrame || s.webkitRequestAnimationFrame || s.msRequestAnimationFrame, l = s.cancelAnimationFrame || s.mozCancelAnimationFrame || s.webkitCancelAnimationFrame || s.msCancelAnimationFrame;
        if (o && l)
          ...
          e.requestAnimationFrame = function(y) {
            return u.push([++m, y]), w || (w = setInterval(function() {
              if (u.length) {
                var T = e.now(), x = p;
                for (p = u, u = x; p.length; )
                  p.shift()[1](T);
              } else
      ...
      ne.exports ? ne.exports = t() : e.OpenSeadragon = t();
    })(Be, function() {
      return F;
    }), (function(e) {
      class t {
         ...
         */
        multiply(i) {
          let n = this.values, a = i.values;
          var s = n[0], o = n[1], l = n[2], u = n[3], p = n[4], m = n[5], w = n[6], y = n[7], T = n[8], x = a[0], E = a[1], P = a[2], L = a[3], B = a[4], z = a[5], U = a[6], W = a[7], G = a[8];
          return new t([
            x * s + E * u + P * w,
            x * o + E * p + P * y,
            x * l + E * m + P * T,
      ...
      e.EventSource = function() {
         ...
         */
        addOnceHandler: function(t, r, i, n, a) {
          var s = this;
          n = n || 1;
          var o = 0, l = function(u) {
            return o++, o === n && s.removeHandler(t, l), r(u);
          };
          return this.addHandler(t, l, i, a);
        },
        /**
        ...
        addHandler: function(t, r, i, n) {
          ...
          var a = this.events[t];
          if (a || (this.events[t] = a = []), r && e.isFunction(r)) {
            var s = a.length, o = { handler: r, userData: i || null, priority: n || 0 };
            for (a[s] = o; s > 0 && a[s - 1].priority < a[s].priority; )
              a[s] = a[s - 1], a[s - 1] = o, s--;
          }
          return !0;
        },
        ...
        removeHandler: function(t, r) {
          var i = this.events[t], n = [], a;
          if (i && e.isArray(i)) {
            for (a = 0; a < i.length; a++)
              i[a].handler !== r && n.push(i[a]);
            this.events[t] = n;
          }
        },
        /**
        ...
        getHandler: function(t) {
          ...
          return !r || !r.length ? null : (r = r.length === 1 ? [r[0]] : Array.apply(null, r), function(i, n) {
            var a, s = r.length;
            for (a = 0; a < s; a++)
              r[a] && (n.eventSource = i, n.userData = r[a].userData, r[a].handler(n));
          });
        },
        /**
      ...
      e.MouseTracker = function(d) {
        ...
        t[this.hash] = {
          ...
          mousewheel: function(v) {
            N(f, v);
          },
          DOMMouseScroll: function(v) {
            N(f, v);
          },
          MozMousePixelScroll: function(v) {
            N(f, v);
          },
          losecapture: function(v) {
            ee(f, v);
          },
          ...
          touchcancel: function(v) {
            te(f, v);
          },
          gesturestart: function(v) {
            se(f, v);
          },
          // Safari/Safari iOS
          gesturechange: function(v) {
            oe(f, v);
          },
          // Safari/Safari iOS
          gotpointercapture: function(v) {
            we(f, v);
          },
          lostpointercapture: function(v) {
            Te(f, v);
          },
          pointerenter: function(v) {
            k(f, v);
          },
          pointerleave: function(v) {
            ce(f, v);
          },
          pointerover: function(v) {
            de(f, v);
          },
          pointerout: function(v) {
            pe(f, v);
          },
          pointerdown: function(v) {
            ae(f, v);
          },
          pointerup: function(v) {
            fe(f, v);
          },
          pointermove: function(v) {
            me(f, v);
          },
          pointercancel: function(v) {
            Ee(f, v);
          },
          pointerupcaptured: function(v) {
            xe(f, v);
          },
          pointermovecaptured: function(v) {
            _e(f, v);
          },
          tracking: !1,
         ...
         */
        setTracking: function(d) {
          return d ? a(this) : s(this), this;
        },
        /**
         ...
         */
        getActivePointersListByType: function(d) {
          var c = t[this.hash], f, v = c ? c.activePointersLists.length : 0, S;
          for (f = 0; f < v; f++)
            if (c.activePointersLists[f].type === d)
              return c.activePointersLists[f];
          return S = new e.MouseTracker.GesturePointList(d), c && c.activePointersLists.push(S), S;
        },
        /**
        ...
        getActivePointerCount: function() {
          var d = t[this.hash], c, f = d.activePointersLists.length, v = 0;
          for (c = 0; c < f; c++)
            v += d.activePointersLists[c].getLength();
          return v;
        },
        /**
      ...
      function i(d) {
        try {
          return d.addEventListener && d.removeEventListener;
        } catch {
          return !1;
        }
      }
      e.MouseTracker.gesturePointVelocityTracker = /* @__PURE__ */ (function() {
        var d = [], c = 0, f = 0, v = function(j, H) {
          return j.hash.toString() + H.type + H.id.toString();
        }, S = function() {
          var j, H = d.length, re, Q, he = e.now(), Se, Pe, Re;
          for (Se = he - f, f = he, j = 0; j < H; j++)
            re = d[j], Q = re.gPoint, Q.direction = Math.atan2(Q.currentPos.y - re.lastPos.y, Q.currentPos.x - re.lastPos.x), Pe = re.lastPos.distanceTo(Q.currentPos), re.lastPos = Q.currentPos, Re = 1e3 * Pe / (Se + 1), Q.speed = 0.75 * Re + 0.25 * Q.speed;
        }, b = function(j, H) {
          var re = v(j, H);
          d.push(
            {
          ...
          ), d.length === 1 && (f = e.now(), c = window.setInterval(S, 50));
        }, A = function(j, H) {
          var re = v(j, H), Q, he = d.length;
          for (Q = 0; Q < he; Q++)
            if (d[Q].guid === re) {
              d.splice(Q, 1), he--, he === 0 && window.clearInterval(c);
              break;
            }
        };
        return {
        ...
        return e.isFunction(d.setPointerCapture) && e.isFunction(d.releasePointerCapture);
        ...
        var d = document.createElement("div");
        return e.isFunction(d.setCapture) && e.isFunction(d.releaseCapture);
        ...
        this._gPoints = [], this.type = d, this.buttons = 0, this.contacts = 0, this.clicks = 0, this.captureCount = 0;
         ...
         * @returns {Number} Number of gesture points in the list.
         */
        removeById: function(d) {
          var c, f = this._gPoints.length;
          for (c = 0; c < f; c++)
            if (this._gPoints[c].id === d) {
         ...
         */
        getByIndex: function(d) {
          return d < this._gPoints.length ? this._gPoints[d] : null;
        },
        /**
         * @function
      ...
      function n(d) {
        var c = t[d.hash], f, v, S, b, A, j = c.activePointersLists.length;
        for (f = 0; f < j; f++)
          if (S = c.activePointersLists[f], S.getLength() > 0) {
            for (A = [], b = S.asArray(), v = 0; v < b.length; v++)
              A.push(b[v]);
      ...
      function a(d) {
        var c = t[d.hash], f, v;
        if (!c.tracking) {
          for (v = 0; v < e.MouseTracker.subscribeEvents.length; v++)
            f = e.MouseTracker.subscribeEvents[v], e.addEvent(
              d.element,
              f,
              c[f],
              f === e.MouseTracker.wheelEventName ? { passive: !1, capture: !1 } : !1
            );
          n(d), c.tracking = !0;
        }
      }
      function s(d) {
        ...
        if (c.tracking) {
          for (v = 0; v < e.MouseTracker.subscribeEvents.length; v++)
            f = e.MouseTracker.subscribeEvents[v], e.removeEvent(
              d.element,
              f,
              c[f],
              !1
      ...
      function o(d, c) {
        ...
        if (c === "pointerevent")
          return {
            upName: "pointerup",
            upHandler: f.pointerupcaptured,
            moveName: "pointermove",
            moveHandler: f.pointermovecaptured
          };
        if (c === "mouse")
          return {
            upName: "pointerup",
        ...
        if (c === "touch")
          return {
            upName: "touchend",
            upHandler: f.touchendcaptured,
            moveName: "touchmove",
            moveHandler: f.touchmovecaptured
          };
      ...
      function l(d, c) {
        ...
        if (e.MouseTracker.havePointerCapture)
          if (e.MouseTracker.havePointerEvents)
            try {
              d.element.setPointerCapture(c.id);
            } catch {
              e.console.warn("setPointerCapture() called on invalid pointer ID");
              return;
            }
          else
            d.element.setCapture(!0);
        else
          f = o(d, e.MouseTracker.havePointerEvents ? "pointerevent" : c.type), r && i(window.top) && e.addEvent(
            window.top,
            f.upName,
            f.upHandler,
            !0
      ...
      function u(d, c) {
        ...
        if (e.MouseTracker.havePointerCapture)
          if (e.MouseTracker.havePointerEvents) {
            if (v = d.getActivePointersListByType(c.type), S = v.getById(c.id), !S || !S.captured)
              return;
            try {
              d.element.releasePointerCapture(c.id);
            } catch {
            }
          } else
            d.element.releaseCapture();
        else
          f = o(d, e.MouseTracker.havePointerEvents ? "pointerevent" : c.type), r && i(window.top) && e.removeEvent(
            window.top,
            f.upName,
            f.upHandler,
            !0
      ...
      function p(d) {
        return e.MouseTracker.havePointerEvents ? d.pointerId : e.MouseTracker.mousePointerId;
      }
      function m(d) {
        return e.MouseTracker.havePointerEvents && d.pointerType ? d.pointerType : "mouse";
      }
      function w(d) {
        return e.MouseTracker.havePointerEvents ? d.isPrimary : !0;
      }
      function y(d) {
        return e.getMousePosition(d);
      }
      function T(d, c) {
        return x(y(d), c);
      }
      function x(d, c) {
        var f = e.getElementOffset(c);
        return d.minus(f);
      }
      function E(d, c) {
        return new e.Point((d.x + c.x) / 2, (d.y + c.y) / 2);
      }
      function P(d, c) {
        var f = {
          originalEvent: c,
        ...
        g(d, f), f.preventDefault && !f.defaultPrevented && e.cancelEvent(c), f.stopPropagation && e.stopEvent(c);
      }
      function L(d, c) {
        var f = {
          originalEvent: c,
      ...
      function B(d, c) {
        ...
        g(d, v), d.keyDownHandler && !v.preventGesture && !v.defaultPrevented && (f = {
          eventSource: d,
          ...
          meta: c.metaKey,
          originalEvent: c,
          preventDefault: v.preventDefault || v.defaultPrevented,
          userData: d.userData
        }, d.keyDownHandler(f)), (f && f.preventDefault || v.preventDefault && !v.defaultPrevented) && e.cancelEvent(c), v.stopPropagation && e.stopEvent(c);
      }
      function z(d, c) {
        var f = null, v = {
          originalEvent: c,
        ...
        g(d, v), d.keyUpHandler && !v.preventGesture && !v.defaultPrevented && (f = {
          eventSource: d,
          keyCode: c.keyCode ? c.keyCode : c.charCode,
          ctrl: c.ctrlKey,
          shift: c.shiftKey,
          ...
          preventDefault: v.preventDefault || v.defaultPrevented,
          userData: d.userData
        }, d.keyUpHandler(f)), (f && f.preventDefault || v.preventDefault && !v.defaultPrevented) && e.cancelEvent(c), v.stopPropagation && e.stopEvent(c);
      }
      function U(d, c) {
        var f = null, v = {
          originalEvent: c,
        ...
        g(d, v), d.keyHandler && !v.preventGesture && !v.defaultPrevented && (f = {
          eventSource: d,
          keyCode: c.keyCode ? c.keyCode : c.charCode,
          ctrl: c.ctrlKey,
          shift: c.shiftKey,
          ...
          preventDefault: v.preventDefault || v.defaultPrevented,
          userData: d.userData
        }, d.keyHandler(f)), (f && f.preventDefault || v.preventDefault && !v.defaultPrevented) && e.cancelEvent(c), v.stopPropagation && e.stopEvent(c);
      }
      function W(d, c) {
        var f = {
          originalEvent: c,
        ...
        g(d, f), d.focusHandler && !f.preventGesture && d.focusHandler(
          {
            eventSource: d,
            originalEvent: c,
            userData: d.userData
      ...
      function G(d, c) {
        ...
        g(d, f), d.blurHandler && !f.preventGesture && d.blurHandler(
          {
            eventSource: d,
            originalEvent: c,
            userData: d.userData
      ...
      function K(d, c) {
        ...
        g(d, v), d.contextMenuHandler && !v.preventGesture && !v.defaultPrevented && (f = {
          eventSource: d,
          position: x(y(c), d.element),
          originalEvent: v.originalEvent,
          preventDefault: v.preventDefault || v.defaultPrevented,
          userData: d.userData
        }, d.contextMenuHandler(f)), (f && f.preventDefault || v.preventDefault && !v.defaultPrevented) && e.cancelEvent(c), v.stopPropagation && e.stopEvent(c);
      }
      function Z(d, c) {
        X(d, c, c);
      }
      function N(d, c) {
        ...
        e.MouseTracker.wheelEventName === "mousewheel" ? f.deltaY = -c.wheelDelta / e.DEFAULT_SETTINGS.pixelsPerWheelLine : f.deltaY = c.detail, X(d, f, c);
      }
      function X(d, c, f) {
        var v = 0, S, b = null;
        v = c.deltaY ? c.deltaY < 0 ? 1 : -1 : 0, S = {
          originalEvent: c,
          eventType: "wheel",
          pointerType: "mouse",
          isEmulated: c !== f
        }, g(d, S), d.scrollHandler && !S.preventGesture && !S.defaultPrevented && (b = {
          eventSource: d,
          pointerType: "mouse",
          position: T(c, d.element),
          scroll: v,
          shift: c.shiftKey,
          isTouchEvent: !1,
          originalEvent: f,
          ...
          userData: d.userData
        }, d.scrollHandler(b)), S.stopPropagation && e.stopEvent(f), (b && b.preventDefault || S.preventDefault && !S.defaultPrevented) && e.cancelEvent(f);
      }
      function ee(d, c) {
        var f = {
        ...
        g(d, v), c.target === d.element && _(d, f, !1), v.stopPropagation && e.stopEvent(c);
      }
      function J(d, c) {
        var f, v, S = c.changedTouches.length, b, A = d.getActivePointersListByType("touch");
        f = e.now(), A.getLength() > c.touches.length - S && e.console.warn("Tracked touch contact count doesn't match event.touches.length");
        var j = {
          originalEvent: c,
        ...
        for (g(d, j), v = 0; v < S; v++)
          b = {
            id: c.changedTouches[v].identifier,
            type: "touch",
            // Simulate isPrimary
            isPrimary: A.getLength() === 0,
            currentPos: y(c.changedTouches[v]),
            currentTime: f
          }, C(d, j, b), M(d, j, b, 0), _(d, b, !0);
        j.preventDefault && !j.defaultPrevented && e.cancelEvent(c), j.stopPropagation && e.stopEvent(c);
      }
      function $(d, c) {
        var f, v, S = c.changedTouches.length, b;
        f = e.now();
        var A = {
          originalEvent: c,
          eventType: "pointerup",
        ...
        for (g(d, A), v = 0; v < S; v++)
          b = {
            ...
            currentPos: y(c.changedTouches[v]),
            currentTime: f
          }, V(d, A, b, 0), _(d, b, !1), D(d, A, b);
        A.preventDefault && !A.defaultPrevented && e.cancelEvent(c), A.stopPropagation && e.stopEvent(c);
      }
      function ie(d, c) {
        var f, v, S = c.changedTouches.length, b;
        f = e.now();
      ...
      function te(d, c) {
        var f = c.changedTouches.length, v, S, b = {
          originalEvent: c,
        ...
        b.stopPropagation && e.stopEvent(c);
      }
      function se(d, c) {
      ...
      function we(d, c) {
        ...
        g(d, f), c.target === d.element && _(d, {
          id: c.pointerId,
          type: m(c)
        }, !0), f.stopPropagation && e.stopEvent(c);
      }
      function Te(d, c) {
        var f = {
          originalEvent: c,
        ...
        g(d, f), c.target === d.element && _(d, {
          id: c.pointerId,
          type: m(c)
        }, !1), f.stopPropagation && e.stopEvent(c);
      }
      function k(d, c) {
        var f = {
          id: p(c),
      ...
      function de(d, c) {
        ...
        g(d, v), O(d, v, f), v.preventDefault && !v.defaultPrevented && e.cancelEvent(c), v.stopPropagation && e.stopEvent(c);
      }
      function pe(d, c) {
        var f = {
          id: p(c),
        ...
        g(d, v), R(d, v, f), v.preventDefault && !v.defaultPrevented && e.cancelEvent(c), v.stopPropagation && e.stopEvent(c);
      }
      function ae(d, c) {
        var f = {
          id: p(c),
          ...
          currentPos: y(c),
          currentTime: e.now()
        }, v = e.MouseTracker.havePointerEvents && f.type === "touch", S = {
          originalEvent: c,
          eventType: "pointerdown",
          pointerType: f.type,
          isEmulated: !1
        };
        g(d, S), M(d, S, f, c.button), S.preventDefault && !S.defaultPrevented && e.cancelEvent(c), S.stopPropagation && e.stopEvent(c), S.shouldCapture && (v ? _(d, f, !0) : l(d, f));
      }
      function fe(d, c) {
        ge(d, c);
      }
      function xe(d, c) {
        var f = d.getActivePointersListByType(m(c));
        f.getById(c.pointerId) && ge(d, c), e.stopEvent(c);
      }
      function ge(d, c) {
        var f;
        f = {
        ...
        g(d, v), V(d, v, f, c.button), v.preventDefault && !v.defaultPrevented && e.cancelEvent(c), v.stopPropagation && e.stopEvent(c), v.shouldReleaseCapture && (c.target === d.element ? u(d, f) : _(d, f, !1));
      }
      function me(d, c) {
        ve(d, c);
      }
      function _e(d, c) {
        var f = d.getActivePointersListByType(m(c));
        f.getById(c.pointerId) && ve(d, c), e.stopEvent(c);
      }
      function ve(d, c) {
        var f = {
          id: p(c),
        ...
        g(d, v), q(d, v, f), v.preventDefault && !v.defaultPrevented && e.cancelEvent(c), v.stopPropagation && e.stopEvent(c);
      }
      function Ee(d, c) {
        var f = {
          id: c.pointerId,
        ...
        g(d, v), I(d, v, f), v.stopPropagation && e.stopEvent(c);
      }
      function ue(d, c) {
        return c.speed = 0, c.direction = 0, c.contactPos = c.currentPos, c.contactTime = c.currentTime, c.lastPos = c.currentPos, c.lastTime = c.currentTime, d.add(c);
      }
      function le(d, c, f) {
        var v, S = c.getById(f.id);
        return S ? (S.captured && (e.console.warn("stopTrackingPointer() called on captured pointer"), u(d, S)), c.removeContact(), v = c.removeById(f.id)) : v = c.getLength(), v;
      }
      function h(d, c) {
        switch (c.eventType) {
          case "pointermove":
            c.isStoppable = !0, c.isCancelable = !0, c.preventDefault = !1, c.preventGesture = !d.hasGestureHandlers, c.stopPropagation = !1;
            break;
          case "pointerover":
          case "pointerout":
          case "contextmenu":
          ...
          case "pointerup":
            ...
            break;
          case "wheel":
            c.isStoppable = !0, c.isCancelable = !0, c.preventDefault = !1, c.preventGesture = !d.hasScrollHandler, c.stopPropagation = !1;
            break;
          ...
          case "pointercancel":
            ...
            break;
          case "click":
            c.isStoppable = !0, c.isCancelable = !0, c.preventDefault = !!d.clickHandler, c.preventGesture = !1, c.stopPropagation = !1;
            break;
          case "dblclick":
            c.isStoppable = !0, c.isCancelable = !0, c.preventDefault = !!d.dblClickHandler, c.preventGesture = !1, c.stopPropagation = !1;
            break;
          case "focus":
          case "blur":
          case "pointerenter":
      ...
      function g(d, c) {
        c.eventSource = d, c.eventPhase = c.originalEvent && typeof c.originalEvent.eventPhase < "u" ? c.originalEvent.eventPhase : 0, c.defaultPrevented = e.eventIsCanceled(c.originalEvent), c.shouldCapture = !1, c.shouldReleaseCapture = !1, c.userData = d.userData, h(d, c), d.preProcessEventHandler && d.preProcessEventHandler(c);
      }
      function _(d, c, f) {
        var v = d.getActivePointersListByType(c.type), S = v.getById(c.id);
        S ? f && !S.captured ? (S.captured = !0, v.captureCount++) : !f && S.captured && (S.captured = !1, v.captureCount--, v.captureCount < 0 && (v.captureCount = 0, e.console.warn("updatePointerCaptured() - pointsList.captureCount went negative"))) : e.console.warn("updatePointerCaptured() called on untracked pointer");
      }
      function C(d, c, f) {
        var v = d.getActivePointersListByType(f.type), S;
        S = v.getById(f.id), S ? (S.insideElement = !0, S.lastPos = S.currentPos, S.lastTime = S.currentTime, S.currentPos = f.currentPos, S.currentTime = f.currentTime, f = S) : (f.captured = !1, f.insideElementPressed = !1, f.insideElement = !0, ue(v, f)), d.enterHandler && d.enterHandler(
          {
            eventSource: d,
            pointerType: f.type,
            position: x(f.currentPos, d.element),
            buttons: v.buttons,
            pointers: d.getActivePointerCount(),
            insideElementPressed: f.insideElementPressed,
            buttonDownAny: v.buttons !== 0,
      ...
      function D(d, c, f) {
        var v = d.getActivePointersListByType(f.type), S, b;
        S = v.getById(f.id), S ? (S.captured ? (S.insideElement = !1, S.lastPos = S.currentPos, S.lastTime = S.currentTime, S.currentPos = f.currentPos, S.currentTime = f.currentTime) : le(d, v, S), f = S) : (f.captured = !1, f.insideElementPressed = !1), (d.leaveHandler || d.exitHandler) && (b = {
          eventSource: d,
          pointerType: f.type,
          // GitHub PR: https://github.com/openseadragon/openseadragon/pull/1754 (gPoint.currentPos && )
          position: f.currentPos && x(f.currentPos, d.element),
          buttons: v.buttons,
          pointers: d.getActivePointerCount(),
          insideElementPressed: f.insideElementPressed,
          buttonDownAny: v.buttons !== 0,
          ...
          originalEvent: c.originalEvent,
          userData: d.userData
        }, d.leaveHandler && d.leaveHandler(b), d.exitHandler && d.exitHandler(b));
      }
      function O(d, c, f) {
        var v, S;
        v = d.getActivePointersListByType(f.type), S = v.getById(f.id), S ? f = S : (f.captured = !1, f.insideElementPressed = !1), d.overHandler && d.overHandler(
          {
            eventSource: d,
            pointerType: f.type,
            position: x(f.currentPos, d.element),
      ...
      function R(d, c, f) {
        var v, S;
        v = d.getActivePointersListByType(f.type), S = v.getById(f.id), S ? f = S : (f.captured = !1, f.insideElementPressed = !1), d.outHandler && d.outHandler({
          eventSource: d,
          pointerType: f.type,
          position: f.currentPos && x(f.currentPos, d.element),
          buttons: v.buttons,
      ...
      function M(d, c, f, v) {
        var S = t[d.hash], b = d.getActivePointersListByType(f.type), A;
        if (typeof c.originalEvent.buttons < "u" ? b.buttons = c.originalEvent.buttons : v === 0 ? b.buttons |= 1 : v === 1 ? b.buttons |= 4 : v === 2 ? b.buttons |= 2 : v === 3 ? b.buttons |= 8 : v === 4 ? b.buttons |= 16 : v === 5 && (b.buttons |= 32), v !== 0) {
          c.shouldCapture = !1, c.shouldReleaseCapture = !1, d.nonPrimaryPressHandler && !c.preventGesture && !c.defaultPrevented && (c.preventDefault = !0, d.nonPrimaryPressHandler(
            {
              eventSource: d,
              pointerType: f.type,
              position: x(f.currentPos, d.element),
        ...
        A = b.getById(f.id), A ? (A.insideElementPressed = !0, A.insideElement = !0, A.originalTarget = c.originalEvent.target, A.contactPos = f.currentPos, A.contactTime = f.currentTime, A.lastPos = A.currentPos, A.lastTime = A.currentTime, A.currentPos = f.currentPos, A.currentTime = f.currentTime, f = A) : (f.captured = !1, f.insideElementPressed = !0, f.insideElement = !0, f.originalTarget = c.originalEvent.target, ue(b, f)), b.addContact(), !c.preventGesture && !c.defaultPrevented ? (c.shouldCapture = !0, c.shouldReleaseCapture = !1, c.preventDefault = !0, (d.dragHandler || d.dragEndHandler || d.pinchHandler) && e.MouseTracker.gesturePointVelocityTracker.addPoint(d, f), b.contacts === 1 ? d.pressHandler && !c.preventGesture && d.pressHandler(
          {
            eventSource: d,
            pointerType: f.type,
            position: x(f.contactPos, d.element),
            buttons: b.buttons,
            isTouchEvent: f.type === "touch",
            originalEvent: c.originalEvent,
            userData: d.userData
          }
        ) : b.contacts === 2 && d.pinchHandler && f.type === "touch" && (S.pinchGPoints = b.asArray(), S.lastPinchDist = S.currentPinchDist = S.pinchGPoints[0].currentPos.distanceTo(S.pinchGPoints[1].currentPos), S.lastPinchCenter = S.currentPinchCenter = E(S.pinchGPoints[0].currentPos, S.pinchGPoints[1].currentPos))) : (c.shouldCapture = !1, c.shouldReleaseCapture = !1);
      }
      function V(d, c, f, v) {
        var S = t[d.hash], b = d.getActivePointersListByType(f.type), A, j, H, re = !1, Q;
        if (typeof c.originalEvent.buttons < "u" ? b.buttons = c.originalEvent.buttons : v === 0 ? b.buttons ^= -2 : v === 1 ? b.buttons ^= -5 : v === 2 ? b.buttons ^= -3 : v === 3 ? b.buttons ^= -9 : v === 4 ? b.buttons ^= -17 : v === 5 && (b.buttons ^= -33), c.shouldCapture = !1, v !== 0) {
          c.shouldReleaseCapture = !1, d.nonPrimaryReleaseHandler && !c.preventGesture && !c.defaultPrevented && (c.preventDefault = !0, d.nonPrimaryReleaseHandler(
            {
              eventSource: d,
              pointerType: f.type,
              position: x(f.currentPos, d.element),
        ...
        H = b.getById(f.id), H ? (b.removeContact(), H.captured && (re = !0), H.lastPos = H.currentPos, H.lastTime = H.currentTime, H.currentPos = f.currentPos, H.currentTime = f.currentTime, H.insideElement || le(d, b, H), A = H.currentPos, j = H.currentTime) : (f.captured = !1, f.insideElementPressed = !1, f.insideElement = !0, ue(b, f), H = f), !c.preventGesture && !c.defaultPrevented && (re ? (c.shouldReleaseCapture = !0, c.preventDefault = !0, (d.dragHandler || d.dragEndHandler || d.pinchHandler) && e.MouseTracker.gesturePointVelocityTracker.removePoint(d, H), b.contacts === 0 ? (d.releaseHandler && A && d.releaseHandler(
          {
            eventSource: d,
            pointerType: H.type,
            position: x(A, d.element),
            buttons: b.buttons,
        ...
        ), d.dragEndHandler && S.sentDragEvent && d.dragEndHandler(
          {
            eventSource: d,
            pointerType: H.type,
            position: x(H.currentPos, d.element),
            speed: H.speed,
        ...
        ), S.sentDragEvent = !1, (d.clickHandler || d.dblClickHandler) && H.insideElement && (Q = j - H.contactTime <= d.clickTimeThreshold && H.contactPos.distanceTo(A) <= d.clickDistThreshold, d.clickHandler && d.clickHandler(
          {
            eventSource: d,
            pointerType: H.type,
            position: x(H.currentPos, d.element),
        ...
        ), d.dblClickHandler && Q && (b.clicks++, b.clicks === 1 ? (S.lastClickPos = A, S.dblClickTimeOut = setTimeout(function() {
          b.clicks = 0;
        }, d.dblClickTimeThreshold)) : b.clicks === 2 && (clearTimeout(S.dblClickTimeOut), b.clicks = 0, S.lastClickPos.distanceTo(A) <= d.dblClickDistThreshold && d.dblClickHandler(
          {
            eventSource: d,
            pointerType: H.type,
            position: x(H.currentPos, d.element),
        ...
        ), S.lastClickPos = null)))) : b.contacts === 2 && d.pinchHandler && H.type === "touch" && (S.pinchGPoints = b.asArray(), S.lastPinchDist = S.currentPinchDist = S.pinchGPoints[0].currentPos.distanceTo(S.pinchGPoints[1].currentPos), S.lastPinchCenter = S.currentPinchCenter = E(S.pinchGPoints[0].currentPos, S.pinchGPoints[1].currentPos))) : (c.shouldReleaseCapture = !1, d.releaseHandler && A && (d.releaseHandler(
          {
            eventSource: d,
            pointerType: H.type,
            position: x(A, d.element),
      ...
      function q(d, c, f) {
        var v = t[d.hash], S = d.getActivePointersListByType(f.type), b, A, j;
        if (typeof c.originalEvent.buttons < "u" && (S.buttons = c.originalEvent.buttons), b = S.getById(f.id), b)
          b.lastPos = b.currentPos, b.lastTime = b.currentTime, b.currentPos = f.currentPos, b.currentTime = f.currentTime;
        else
          return;
        c.shouldCapture = !1, c.shouldReleaseCapture = !1, d.stopHandler && f.type === "mouse" && (clearTimeout(d.stopTimeOut), d.stopTimeOut = setTimeout(function() {
          Y(d, c.originalEvent, f.type);
        }, d.stopDelay)), S.contacts === 0 ? d.moveHandler && d.moveHandler(
          {
            eventSource: d,
            pointerType: f.type,
            position: x(f.currentPos, d.element),
        ...
        ) : S.contacts === 1 ? (d.moveHandler && (b = S.asArray()[0], d.moveHandler(
          {
            eventSource: d,
            pointerType: b.type,
            position: x(b.currentPos, d.element),
            buttons: S.buttons,
            isTouchEvent: b.type === "touch",
            originalEvent: c.originalEvent,
            userData: d.userData
          }
        )), d.dragHandler && !c.preventGesture && !c.defaultPrevented && (b = S.asArray()[0], j = b.currentPos.minus(b.lastPos), d.dragHandler(
          {
            eventSource: d,
            pointerType: b.type,
            position: x(b.currentPos, d.element),
        ...
        ), c.preventDefault = !0, v.sentDragEvent = !0)) : S.contacts === 2 && (d.moveHandler && (A = S.asArray(), d.moveHandler(
          {
            eventSource: d,
            pointerType: A[0].type,
            position: x(E(A[0].currentPos, A[1].currentPos), d.element),
            buttons: S.buttons,
            isTouchEvent: A[0].type === "touch",
            originalEvent: c.originalEvent,
            userData: d.userData
          }
        )), d.pinchHandler && f.type === "touch" && !c.preventGesture && !c.defaultPrevented && (j = v.pinchGPoints[0].currentPos.distanceTo(v.pinchGPoints[1].currentPos), j !== v.currentPinchDist && (v.lastPinchDist = v.currentPinchDist, v.currentPinchDist = j, v.lastPinchCenter = v.currentPinchCenter, v.currentPinchCenter = E(v.pinchGPoints[0].currentPos, v.pinchGPoints[1].currentPos), d.pinchHandler(
          {
            eventSource: d,
            pointerType: "touch",
            gesturePoints: v.pinchGPoints,
            lastCenter: x(v.lastPinchCenter, d.element),
            center: x(v.currentPinchCenter, d.element),
            lastDistance: v.lastPinchDist,
            distance: v.currentPinchDist,
            shift: c.originalEvent.shiftKey,
            originalEvent: c.originalEvent,
            userData: d.userData
          }
      ...
      function I(d, c, f) {
        var v = d.getActivePointersListByType(f.type), S;
        S = v.getById(f.id), S && le(d, v, S);
      }
      function Y(d, c, f) {
        d.stopHandler && d.stopHandler({
          eventSource: d,
          pointerType: f,
          position: T(c, d.element),
          buttons: d.getActivePointersListByType(f).buttons,
          isTouchEvent: f === "touch",
          originalEvent: c,
          userData: d.userData
        });
      }
      ...
      e.ControlDock = function(r) {
        var i = ["topleft", "topright", "bottomright", "bottomleft"], n, a;
        for (e.extend(!0, this, {
          ...
          return !1;
        }, this.element && (this.element = e.getElement(this.element), this.element.appendChild(this.container), e.getElementStyle(this.element).position === "static" && (this.element.style.position = "relative"), this.container.style.width = "100%", this.container.style.height = "100%"), a = 0; a < i.length; a++)
          n = i[a], this.controls[n] = e.makeNeutralElement("div"), this.controls[n].style.position = "absolute", n.match("left") && (this.controls[n].style.left = "0px"), n.match("right") && (this.controls[n].style.right = "0px"), n.match("top") && (this.controls[n].style.top = "0px"), n.match("bottom") && (this.controls[n].style.bottom = "0px");
      ...
      e.Viewer = function(h) {
        ...
        }), h.config && (e.extend(!0, h, h.config), delete h.config);
        let D = [
          "useCanvas"
          // deprecated
        ];
        if (h.drawerOptions = Object.assign(
          {},
          D.reduce((R, M) => (R[M] = h[M], delete h[M], R), {}),
          h.drawerOptions
        ), e.extend(!0, this, {
          ...
          profiler: null
        }, e.DEFAULT_SETTINGS, h), typeof this.hash > "u")
        ...
        typeof t[this.hash] < "u" && e.console.warn("Hash " + this.hash + " has already been used."), t[this.hash] = {
          ...
          var M = e.getString("Errors.OpenFailed", R.eventSource, R.message);
          _._showMessage(M);
        }), e.ControlDock.call(this, h), this.xmlPath && (this.tileSources = [this.xmlPath]), this.element = this.element || document.getElementById(this.id), this.canvas = e.makeNeutralElement("div"), this.canvas.className = "openseadragon-canvas", (function(R) {
          R.width = "100%", R.height = "100%", R.overflow = "hidden", R.position = "absolute", R.top = "0px", R.left = "0px";
        })(this.canvas.style), e.setElementTouchActionNone(this.canvas), h.tabIndex !== "" && (this.canvas.tabIndex = h.tabIndex === void 0 ? 0 : h.tabIndex), this.container.className = "openseadragon-container", (function(R) {
          ...
          focusHandler: e.delegate(this, ee),
          ...
          _.viewport && _.viewport._setContentBounds(_.world.getHomeBounds(), _.world.getContentFactor());
        }), this.world.addHandler("item-index-change", function(R) {
          _.source = _.world.getItemAt(0).source;
        ...
        for (this.drawer.setImageSmoothingEnabled(this.imageSmoothingEnabled), this.overlaysContainer = e.makeNeutralElement("div"), this.canvas.appendChild(this.overlaysContainer), this.drawer.canRotate() || (this.rotateLeft && (C = this.buttonGroup.buttons.indexOf(this.rotateLeft), this.buttonGroup.buttons.splice(C, 1), this.buttonGroup.element.removeChild(this.rotateLeft.element)), this.rotateRight && (C = this.buttonGroup.buttons.indexOf(this.rotateRight), this.buttonGroup.buttons.splice(C, 1), this.buttonGroup.element.removeChild(this.rotateRight.element))), this._addUpdatePixelDensityRatioEvent(), this.showNavigator && (this.navigator = new e.Navigator({
        ...
        })), this.sequenceMode && this.bindSequenceControls(), this.tileSources && this.open(this.tileSources), C = 0; C < this.customControls.length; C++)
          this.addControl(
            this.customControls[C].id,
            { anchor: this.customControls[C].anchor }
          );
        e.requestAnimationFrame(function() {
          u(_);
        ...
        /** @lends OpenSeadragon.Viewer.prototype */
        {
          ...
          // deprecated
          openDzi: function(h) {
            return e.console.error("[Viewer.openDzi] this function is deprecated; use Viewer.open() instead."), this.open(h);
          },
          // deprecated
          openTileSource: function(h) {
            return e.console.error("[Viewer.openTileSource] this function is deprecated; use Viewer.open() instead."), this.open(h);
          },
          //deprecated
          get buttons() {
          ...
          open: function(h, g) {
            ...
            if (this.close(), !h)
              return this;
            if (this.sequenceMode && e.isArray(h))
              return this.referenceStrip && (this.referenceStrip.destroy(), this.referenceStrip = null), typeof g < "u" && !isNaN(g) && (this.initialPage = g), this.tileSources = h, this._sequenceIndex = Math.max(0, Math.min(this.tileSources.length - 1, this.initialPage)), this.tileSources.length && (this.open(this.tileSources[this._sequenceIndex]), this.showReferenceStrip && this.addReferenceStrip()), this._updateSequenceButtons(this._sequenceIndex), this;
            if (e.isArray(h) || (h = [h]), !h.length)
              return this;
            this._opening = !0;
            for (var C = h.length, D = 0, O = 0, R, M = function() {
              if (D + O === C)
                if (D) {
                  (_._firstOpen || !_.preserveViewport) && (_.viewport.goHome(!0), _.viewport.update()), _._firstOpen = !1;
                  var I = h[0];
                  if (I.tileSource && (I = I.tileSource), _.overlays && !_.preserveOverlays)
                    for (var Y = 0; Y < _.overlays.length; Y++)
                      _.currentOverlays[Y] = a(_, _.overlays[Y]);
                  _._drawOverlays(), _._opening = !1, _.raiseEvent("open", { source: I });
                } else
                  _._opening = !1, _.raiseEvent("open-failed", R);
            }, V = function(I) {
              (!e.isPlainObject(I) || !I.tileSource) && (I = {
                tileSource: I
              }), I.index !== void 0 && (e.console.error("[Viewer.open] setting indexes here is not supported; use addTiledImage instead"), delete I.index), I.collectionImmediately === void 0 && (I.collectionImmediately = !0);
              var Y = I.success;
              I.success = function(c) {
                if (D++, I.tileSource.overlays)
                  for (var f = 0; f < I.tileSource.overlays.length; f++)
                    _.addOverlay(I.tileSource.overlays[f]);
                Y && Y(c), M();
              };
              var d = I.error;
              I.error = function(c) {
          ...
          requestDrawer(h, g) {
            ...
            g = e.extend(!0, _, g);
            const C = g.mainDrawer, D = g.redrawImmediately, O = g.drawerOptions, R = this.drawer;
            let M = null;
            if (h && h.prototype instanceof e.DrawerBase ? (M = h, h = "custom") : typeof h == "string" && (M = e.determineDrawer(h)), M || e.console.warn("Unsupported drawer! Drawer must be an existing string type, or a class that extends OpenSeadragon.DrawerBase."), M && M.isSupported()) {
              R && C && R.destroy();
              const V = new M({
                viewer: this,
                ...
                options: O || this.drawerOptions[h]
              });
              return C && (this.drawer = V, D && this.forceRedraw()), V;
            }
            return !1;
          },
          /**
           ...
           */
          setMouseNavEnabled: function(h) {
            return this.innerTracker.setTracking(h), this.outerTracker.setTracking(h), this.raiseEvent("mouse-enabled", { enabled: h }), this;
          },
          /**
           * @function
           * @returns {Boolean}
           */
          areControlsEnabled: function() {
            var h = this.controls.length, g;
            for (g = 0; g < this.controls.length; g++)
              h = h && this.controls[g].isVisible();
            return h;
          },
          /**
           ...
           */
          setControlsEnabled: function(h) {
            return h ? m(this) : u(this), this.raiseEvent("controls-enabled", { enabled: h }), this;
          },
          /**
           ...
           */
          setDebugMode: function(h) {
            for (var g = 0; g < this.world.getItemCount(); g++)
              this.world.getItemAt(g).debugMode = h;
            this.debugMode = h, this.forceRedraw();
          },
          /**
           ...
           */
          setAjaxHeaders: function(h, g) {
            if (h === null && (h = {}), !e.isPlainObject(h)) {
              console.error("[Viewer.setAjaxHeaders] Ignoring invalid headers, must be a plain object");
              return;
            }
            if (g === void 0 && (g = !0), this.ajaxHeaders = h, g) {
              for (var _ = 0; _ < this.world.getItemCount(); _++)
                this.world.getItemAt(_)._updateAjaxHeaders(!0);
              if (this.navigator && this.navigator.setAjaxHeaders(this.ajaxHeaders, !0), this.referenceStrip && this.referenceStrip.miniViewers)
                for (var C in this.referenceStrip.miniViewers)
                  this.referenceStrip.miniViewers[C].setAjaxHeaders(this.ajaxHeaders, !0);
            }
          },
          /**
          ...
          setFullPage: function(h) {
            ...
            if (h && this.element) {
              ...
              for (this.element.style.margin = this.elementMargin, this.element.style.padding = this.elementPadding, _.margin = this.bodyMargin, C.margin = this.docMargin, _.padding = this.bodyPadding, C.padding = this.docPadding, _.width = this.bodyWidth, C.width = this.docWidth, _.height = this.bodyHeight, C.height = this.docHeight, _.display = this.bodyDisplay, g.removeChild(this.element), O = this.previousBody.length, R = 0; R < O; R++)
              ...
              var V = 0, q = function() {
                e.setPageScroll(D.pageScroll);
                var I = e.getPageScroll();
                V++, V < 10 && (I.x !== D.pageScroll.x || I.y !== D.pageScroll.y) && e.requestAnimationFrame(q);
              };
              e.requestAnimationFrame(q), t[this.hash].fullPage = !1, e.delegate(this, te)({});
            }
            return this.navigator && this.viewport && this.navigator.update(this.viewport), this.raiseEvent("full-page", { fullPage: h }), this;
          },
          /**
           ...
           */
          setFullScreen: function(h) {
            var g = this;
            if (!e.supportsFullScreen)
              return this.setFullPage(h);
            if (e.isFullScreen() === h)
              return this;
            var _ = {
              fullScreen: h,
            ...
            if (this.raiseEvent("pre-full-screen", _), _.preventDefaultAction)
              return this;
            if (h) {
              ...
              var C = function() {
                ...
                D || (e.removeEvent(document, e.fullScreenEventName, C), e.removeEvent(document, e.fullScreenErrorEventName, C), g.setFullPage(!1), g.isFullPage() && (g.element.style.width = g.fullPageStyleWidth, g.element.style.height = g.fullPageStyleHeight)), g.navigator && g.viewport && setTimeout(function() {
                  g.navigator.update(g.viewport);
                }), g.raiseEvent("full-screen", { fullScreen: D });
              };
              e.addEvent(document, e.fullScreenEventName, C), e.addEvent(document, e.fullScreenErrorEventName, C), e.requestFullScreen(document.body);
            } else
              e.exitFullScreen();
            return this;
          },
          ...
          setVisible: function(h) {
            return this.container.style.visibility = h ? "" : "hidden", this.raiseEvent("visible", { visible: h }), this;
          },
          /**
          ...
          addTiledImage: function(h) {
            e.console.assert(h, "[Viewer.addTiledImage] options is required"), e.console.assert(h.tileSource, "[Viewer.addTiledImage] options.tileSource is required"), e.console.assert(
              !h.replace || h.index > -1 && h.index < this.world.getItemCount(),
              "[Viewer.addTiledImage] if options.replace is used, options.index must be a valid index in Viewer.world"
            );
            var g = this;
            h.replace && (h.replaceItem = g.world.getItemAt(h.index)), this._hideMessage(), h.placeholderFillStyle === void 0 && (h.placeholderFillStyle = this.placeholderFillStyle), h.opacity === void 0 && (h.opacity = this.opacity), h.preload === void 0 && (h.preload = this.preload), h.compositeOperation === void 0 && (h.compositeOperation = this.compositeOperation), h.crossOriginPolicy === void 0 && (h.crossOriginPolicy = h.tileSource.crossOriginPolicy !== void 0 ? h.tileSource.crossOriginPolicy : this.crossOriginPolicy), h.ajaxWithCredentials === void 0 && (h.ajaxWithCredentials = this.ajaxWithCredentials), h.loadTilesWithAjax === void 0 && (h.loadTilesWithAjax = this.loadTilesWithAjax), e.isPlainObject(h.ajaxHeaders) || (h.ajaxHeaders = {});
            var _ = {
              options: h
            };
            function C(R) {
              for (var M = 0; M < g._loadQueue.length; M++)
                if (g._loadQueue[M] === _) {
                  g._loadQueue.splice(M, 1);
                  break;
                }
              g._loadQueue.length === 0 && D(_), g.raiseEvent("add-item-failed", R), h.error && h.error(R);
            }
            function D(R) {
            ...
            function O() {
              for (var R, M, V; g._loadQueue.length && (R = g._loadQueue[0], !!R.tileSource); ) {
                if (g._loadQueue.splice(0, 1), R.options.replace) {
                  var q = g.world.getIndexOfItem(R.options.replaceItem);
                  q !== -1 && (R.options.index = q), g.world.removeItem(R.options.replaceItem);
                }
                M = new e.TiledImage({
                  viewer: g,
                  source: R.tileSource,
                  ...
                  maxTilesPerFrame: g.maxTilesPerFrame,
                ...
                }), g.collectionMode && g.world.setAutoRefigureSizes(!1), g.navigator && (V = e.extend({}, R.options, {
                  replace: !1,
                  // navigator already removed the layer, nothing to replace
                  originalTiledImage: M,
                  tileSource: R.tileSource
                }), g.navigator.addTiledImage(V)), g.world.addItem(M, {
                  index: R.options.index
                }), g._loadQueue.length === 0 && D(R), g.world.getItemCount() === 1 && !g.preserveViewport && g.viewport.goHome(!0), R.options.success && R.options.success({
                  item: M
                });
              }
            }
            n(this, h.tileSource, h, function(R) {
              _.tileSource = R, O();
            }, function(R) {
              R.options = h, C(R), O();
            });
           ...
           * @fires OpenSeadragon.Viewer.event:add-item-failed
           */
          addSimpleImage: function(h) {
            e.console.assert(h, "[Viewer.addSimpleImage] options is required"), e.console.assert(h.url, "[Viewer.addSimpleImage] options.url is required");
            var g = e.extend({}, h, {
              tileSource: {
                type: "image",
                url: h.url
          ...
          addLayer: function(h) {
            ...
            var _ = e.extend({}, h, {
              ...
              error: function(C) {
                g.raiseEvent("add-layer-failed", C);
              }
            });
            return this.addTiledImage(_), this;
          },
          // deprecated
          getLayerAtLevel: function(h) {
            return e.console.error("[Viewer.getLayerAtLevel] this function is deprecated; use World.getItemAt() instead."), this.world.getItemAt(h);
          },
          // deprecated
          getLevelOfLayer: function(h) {
            return e.console.error("[Viewer.getLevelOfLayer] this function is deprecated; use World.getIndexOfItem() instead."), this.world.getIndexOfItem(h);
          },
          // deprecated
          ...
          // deprecated
          setLayerLevel: function(h, g) {
            return e.console.error("[Viewer.setLayerLevel] this function is deprecated; use World.setItemIndex() instead."), this.world.setItemIndex(h, g);
          },
          // deprecated
          removeLayer: function(h) {
            return e.console.error("[Viewer.removeLayer] this function is deprecated; use World.removeItem() instead."), this.world.removeItem(h);
          },
          /**
          ...
          bindSequenceControls: function() {
            var h = e.delegate(this, w), g = e.delegate(this, y), _ = e.delegate(this, this.goToNextPage), C = e.delegate(this, this.goToPreviousPage), D = this.navImages, O = !0;
            return this.showSequenceControl && ((this.previousButton || this.nextButton) && (O = !1), this.previousButton = new e.Button({
              ...
              srcRest: k(this.prefixUrl, D.previous.REST),
              srcGroup: k(this.prefixUrl, D.previous.GROUP),
              srcHover: k(this.prefixUrl, D.previous.HOVER),
              srcDown: k(this.prefixUrl, D.previous.DOWN),
              onRelease: C,
              onFocus: h,
              onBlur: g
              ...
              srcRest: k(this.prefixUrl, D.next.REST),
              srcGroup: k(this.prefixUrl, D.next.GROUP),
              srcHover: k(this.prefixUrl, D.next.HOVER),
              srcDown: k(this.prefixUrl, D.next.DOWN),
              onRelease: _,
              onFocus: h,
              onBlur: g
          ...
          bindStandardControls: function() {
            var h = e.delegate(this, ce), g = e.delegate(this, pe), _ = e.delegate(this, xe), C = e.delegate(this, de), D = e.delegate(this, ge), O = e.delegate(this, _e), R = e.delegate(this, ve), M = e.delegate(this, Ee), V = e.delegate(this, ue), q = e.delegate(this, le), I = e.delegate(this, w), Y = e.delegate(this, y), d = this.navImages, c = [], f = !0;
            return this.showNavigationControl && ((this.zoomInButton || this.zoomOutButton || this.homeButton || this.fullPageButton || this.rotateLeftButton || this.rotateRightButton || this.flipButton) && (f = !1), this.showZoomControl && (c.push(this.zoomInButton = new e.Button({
              element: this.zoomInButton ? e.getElement(this.zoomInButton) : null,
              clickTimeThreshold: this.clickTimeThreshold,
              clickDistThreshold: this.clickDistThreshold,
              tooltip: e.getString("Tooltips.ZoomIn"),
              srcRest: k(this.prefixUrl, d.zoomIn.REST),
              srcGroup: k(this.prefixUrl, d.zoomIn.GROUP),
              srcHover: k(this.prefixUrl, d.zoomIn.HOVER),
              srcDown: k(this.prefixUrl, d.zoomIn.DOWN),
              onPress: h,
              onRelease: g,
              onClick: _,
              onEnter: h,
              ...
              srcRest: k(this.prefixUrl, d.zoomOut.REST),
              srcGroup: k(this.prefixUrl, d.zoomOut.GROUP),
              srcHover: k(this.prefixUrl, d.zoomOut.HOVER),
              srcDown: k(this.prefixUrl, d.zoomOut.DOWN),
              onPress: C,
              onRelease: g,
              onClick: D,
              onEnter: C,
              ...
              srcRest: k(this.prefixUrl, d.home.REST),
              srcGroup: k(this.prefixUrl, d.home.GROUP),
              srcHover: k(this.prefixUrl, d.home.HOVER),
              srcDown: k(this.prefixUrl, d.home.DOWN),
              onRelease: O,
              onFocus: I,
              onBlur: Y
              ...
              srcRest: k(this.prefixUrl, d.fullpage.REST),
              srcGroup: k(this.prefixUrl, d.fullpage.GROUP),
              srcHover: k(this.prefixUrl, d.fullpage.HOVER),
              srcDown: k(this.prefixUrl, d.fullpage.DOWN),
              onRelease: R,
              onFocus: I,
              onBlur: Y
              ...
              srcRest: k(this.prefixUrl, d.rotateleft.REST),
              srcGroup: k(this.prefixUrl, d.rotateleft.GROUP),
              srcHover: k(this.prefixUrl, d.rotateleft.HOVER),
              srcDown: k(this.prefixUrl, d.rotateleft.DOWN),
              onRelease: M,
              onFocus: I,
              onBlur: Y
              ...
              srcRest: k(this.prefixUrl, d.rotateright.REST),
              srcGroup: k(this.prefixUrl, d.rotateright.GROUP),
              srcHover: k(this.prefixUrl, d.rotateright.HOVER),
              srcDown: k(this.prefixUrl, d.rotateright.DOWN),
              onRelease: V,
              onFocus: I,
              onBlur: Y
              ...
              srcRest: k(this.prefixUrl, d.flip.REST),
              srcGroup: k(this.prefixUrl, d.flip.GROUP),
              srcHover: k(this.prefixUrl, d.flip.HOVER),
              srcDown: k(this.prefixUrl, d.flip.DOWN),
              onRelease: q,
              onFocus: I,
              onBlur: Y
            })), f ? (this.buttonGroup = new e.ButtonGroup({
              buttons: c,
              clickTimeThreshold: this.clickTimeThreshold,
              clickDistThreshold: this.clickDistThreshold
            }), this.navControl = this.buttonGroup.element, this.addHandler("open", e.delegate(this, me)), this.toolbar ? this.toolbar.addControl(
              this.navControl,
           ...
           */
          goToPage: function(h) {
            return this.tileSources && h >= 0 && h < this.tileSources.length && (this._sequenceIndex = h, this._updateSequenceButtons(h), this.open(this.tileSources[h]), this.referenceStrip && this.referenceStrip.setFocus(h), this.raiseEvent("page", { page: h })), this;
          },
          /**
            ...
            */
          addOverlay: function(h, g, _, C) {
            var D;
            if (e.isPlainObject(h) ? D = h : D = {
              element: h,
              location: g,
              placement: _,
              onDraw: C
            }, h = e.getElement(D.element), s(this.currentOverlays, h) >= 0)
              return this;
            var O = a(this, D);
           ...
           */
          updateOverlay: function(h, g, _) {
            var C;
            return h = e.getElement(h), C = s(this.currentOverlays, h), C >= 0 && (this.currentOverlays[C].update(g, _), t[this.hash].forceRedraw = !0, this.raiseEvent("update-overlay", {
              element: h,
              location: g,
              placement: _
            })), this;
           ...
           */
          removeOverlay: function(h) {
            var g;
            return h = e.getElement(h), g = s(this.currentOverlays, h), g >= 0 && (this.currentOverlays[g].destroy(), this.currentOverlays.splice(g, 1), t[this.hash].forceRedraw = !0, this.raiseEvent("remove-overlay", {
              element: h
            })), this;
          },
          /**
          ...
          */
          getOverlayById: function(h) {
            var g;
            return h = e.getElement(h), g = s(this.currentOverlays, h), g >= 0 ? this.currentOverlays[g] : null;
          },
          /**
           ...
           */
          _updateSequenceButtons: function(h) {
            this.nextButton && (!this.tileSources || this.tileSources.length - 1 === h ? this.navPrevNextWrap || this.nextButton.disable() : this.nextButton.enable()), this.previousButton && (h > 0 ? this.previousButton.enable() : this.navPrevNextWrap || this.previousButton.disable());
          },
          /**
           ...
           */
          _showMessage: function(h) {
            this._hideMessage();
            var g = e.makeNeutralElement("div");
            g.appendChild(document.createTextNode(h)), this.messageDiv = e.makeCenteredNode(g), e.addClass(this.messageDiv, "openseadragon-message"), this.container.appendChild(this.messageDiv);
          },
          /**
          ...
          _hideMessage: function() {
            var h = this.messageDiv;
            h && (h.parentNode.removeChild(h), delete this.messageDiv);
          },
          /**
           ...
           */
          gestureSettingsByDeviceType: function(h) {
            switch (h) {
              case "mouse":
          ...
          _drawOverlays: function() {
            var h, g = this.currentOverlays.length;
            for (h = 0; h < g; h++)
              this.currentOverlays[h].drawHTML(this.overlaysContainer, this.viewport);
          },
          /**
          ...
          _updatePixelDensityRatio: function() {
            var h = e.pixelDensityRatio, g = e.getCurrentPixelDensityRatio();
            h !== g && (e.pixelDensityRatio = g, this.forceResize());
          },
          /**
          ...
          goToPreviousPage: function() {
            var h = this._sequenceIndex - 1;
            this.navPrevNextWrap && h < 0 && (h += this.tileSources.length), this.goToPage(h);
          },
          /**
           * Sets the image source to the source with index equal to
           * currentIndex + 1. Changes current image in sequence mode.
          ...
          goToNextPage: function() {
            var h = this._sequenceIndex + 1;
            this.navPrevNextWrap && h >= this.tileSources.length && (h = 0), this.goToPage(h);
          },
      ...
      function i(h) {
        return h = e.getElement(h), new e.Point(
          h.clientWidth === 0 ? 1 : h.clientWidth,
          h.clientHeight === 0 ? 1 : h.clientHeight
        );
      }
      function n(h, g, _, C, D) {
        var O = h;
        if (e.type(g) === "string") {
          if (g.match(/^\s*<.*>\s*$/))
            g = e.parseXml(g);
        ...
        function M(V, q) {
          V.ready ? C(V) : (V.addHandler("ready", function() {
            C(V);
          }), V.addHandler("open-failed", function(I) {
            D({
              message: I.message,
              source: q
            });
        ...
        setTimeout(function() {
          if (e.type(g) === "string")
            g = new e.TileSource({
              url: g,
              crossOriginPolicy: _.crossOriginPolicy !== void 0 ? _.crossOriginPolicy : h.crossOriginPolicy,
              ajaxWithCredentials: h.ajaxWithCredentials,
              ajaxHeaders: _.ajaxHeaders ? _.ajaxHeaders : h.ajaxHeaders,
              splitHashDataForPost: h.splitHashDataForPost,
              success: function(Y) {
                C(Y.tileSource);
              }
            }), g.addHandler("open-failed", function(Y) {
              D(Y);
            });
          else if (e.isPlainObject(g) || g.nodeType)
            if (g.crossOriginPolicy === void 0 && (_.crossOriginPolicy !== void 0 || h.crossOriginPolicy !== void 0) && (g.crossOriginPolicy = _.crossOriginPolicy !== void 0 ? _.crossOriginPolicy : h.crossOriginPolicy), g.ajaxWithCredentials === void 0 && (g.ajaxWithCredentials = h.ajaxWithCredentials), e.isFunction(g.getTileUrl)) {
              var V = new e.TileSource(g);
              V.getTileUrl = g.getTileUrl, C(V);
            } else {
              var q = e.TileSource.determineType(O, g);
              if (!q) {
                D({
              ...
              var I = q.prototype.configure.apply(O, [g]);
              M(new q(I), g);
            }
          else
            M(g, g);
      ...
      function a(h, g) {
        ...
        var _ = null;
        if (g.element)
          _ = e.getElement(g.element);
        else {
          var C = g.id ? g.id : "openseadragon-overlay-" + Math.floor(Math.random() * 1e7);
          _ = e.getElement(g.id), _ || (_ = document.createElement("a"), _.href = "#/overlay/" + C), _.id = C, e.addClass(
            _,
            g.className ? g.className : "openseadragon-overlay"
          );
        }
        var D = g.location, O = g.width, R = g.height;
        if (!D) {
          var M = g.x, V = g.y;
          if (g.px !== void 0) {
            var q = h.viewport.imageToViewportRectangle(new e.Rect(
              g.px,
              g.py,
              O || 0,
              R || 0
            ));
            M = q.x, V = q.y, O = O !== void 0 ? q.width : void 0, R = R !== void 0 ? q.height : void 0;
          }
          D = new e.Point(M, V);
        }
        var I = g.placement;
        return I && e.type(I) === "string" && (I = e.Placement[g.placement.toUpperCase()]), new e.Overlay({
          element: _,
          location: D,
          placement: I,
          onDraw: g.onDraw,
      ...
      function u(h) {
        h.autoHideControls && (h.controlsShouldFade = !0, h.controlsFadeBeginTime = e.now() + h.controlsFadeDelay, window.setTimeout(function() {
          l(h);
        }, h.controlsFadeDelay));
      }
      function p(h) {
        var g, _, C, D;
        if (h.controlsShouldFade) {
          for (g = e.now(), _ = g - h.controlsFadeBeginTime, C = 1 - _ / h.controlsFadeLength, C = Math.min(1, C), C = Math.max(0, C), D = h.controls.length - 1; D >= 0; D--)
            h.controls[D].autoFade && h.controls[D].setOpacity(C);
          C > 0 && l(h);
        }
      }
      function m(h) {
        var g;
        for (h.controlsShouldFade = !1, g = h.controls.length - 1; g >= 0; g--)
          h.controls[g].setOpacity(1);
      }
      function w() {
        m(this);
      }
      ...
      function T(h) {
        ...
        this.raiseEvent("canvas-contextmenu", g), h.preventDefault = g.preventDefault;
      }
      function x(h) {
        var g = {
          originalEvent: h.originalEvent,
          preventDefaultAction: !1,
          preventVerticalPan: h.preventVerticalPan || !this.panVertical,
          preventHorizontalPan: h.preventHorizontalPan || !this.panHorizontal
        };
        if (this.raiseEvent("canvas-key", g), !g.preventDefaultAction && !h.ctrl && !h.alt && !h.meta)
          switch (h.keyCode) {
            case 38:
              g.preventVerticalPan || (h.shift ? this.viewport.zoomBy(1.1) : this.viewport.panBy(this.viewport.deltaPointsFromPixels(new e.Point(0, -this.pixelsPerArrowPress))), this.viewport.applyConstraints()), h.preventDefault = !0;
              break;
            case 40:
              g.preventVerticalPan || (h.shift ? this.viewport.zoomBy(0.9) : this.viewport.panBy(this.viewport.deltaPointsFromPixels(new e.Point(0, this.pixelsPerArrowPress))), this.viewport.applyConstraints()), h.preventDefault = !0;
              break;
            case 37:
              g.preventHorizontalPan || (this.viewport.panBy(this.viewport.deltaPointsFromPixels(new e.Point(-this.pixelsPerArrowPress, 0))), this.viewport.applyConstraints()), h.preventDefault = !0;
              break;
            case 39:
              g.preventHorizontalPan || (this.viewport.panBy(this.viewport.deltaPointsFromPixels(new e.Point(this.pixelsPerArrowPress, 0))), this.viewport.applyConstraints()), h.preventDefault = !0;
              break;
            case 187:
              this.viewport.zoomBy(1.1), this.viewport.applyConstraints(), h.preventDefault = !0;
              break;
            case 189:
              this.viewport.zoomBy(0.9), this.viewport.applyConstraints(), h.preventDefault = !0;
              break;
            case 48:
              this.viewport.goHome(), this.viewport.applyConstraints(), h.preventDefault = !0;
              break;
            case 87:
              g.preventVerticalPan || (h.shift ? this.viewport.zoomBy(1.1) : this.viewport.panBy(this.viewport.deltaPointsFromPixels(new e.Point(0, -40))), this.viewport.applyConstraints()), h.preventDefault = !0;
              break;
            case 83:
              g.preventVerticalPan || (h.shift ? this.viewport.zoomBy(0.9) : this.viewport.panBy(this.viewport.deltaPointsFromPixels(new e.Point(0, 40))), this.viewport.applyConstraints()), h.preventDefault = !0;
              break;
            case 65:
              g.preventHorizontalPan || (this.viewport.panBy(this.viewport.deltaPointsFromPixels(new e.Point(-40, 0))), this.viewport.applyConstraints()), h.preventDefault = !0;
              break;
            case 68:
              g.preventHorizontalPan || (this.viewport.panBy(this.viewport.deltaPointsFromPixels(new e.Point(40, 0))), this.viewport.applyConstraints()), h.preventDefault = !0;
              break;
            case 82:
              h.shift ? this.viewport.flipped ? this.viewport.setRotation(this.viewport.getRotation() + this.rotationIncrement) : this.viewport.setRotation(this.viewport.getRotation() - this.rotationIncrement) : this.viewport.flipped ? this.viewport.setRotation(this.viewport.getRotation() - this.rotationIncrement) : this.viewport.setRotation(this.viewport.getRotation() + this.rotationIncrement), this.viewport.applyConstraints(), h.preventDefault = !0;
              break;
            case 70:
              this.viewport.toggleFlip(), h.preventDefault = !0;
              break;
            case 74:
      ...
      function P(h) {
        var g, _ = document.activeElement === this.canvas;
        _ || this.canvas.focus(), this.viewport.flipped && (h.position.x = this.viewport.getContainerSize().x - h.position.x);
        var C = {
          tracker: h.eventSource,
          position: h.position,
          quick: h.quick,
        ...
        this.raiseEvent("canvas-click", C), !C.preventDefaultAction && this.viewport && h.quick && (g = this.gestureSettingsByDeviceType(h.pointerType), g.clickToZoom === !0 && (this.viewport.zoomBy(
          h.shift ? 1 / this.zoomPerClick : this.zoomPerClick,
          g.zoomToRefPoint ? this.viewport.pointFromPixel(h.position, !0) : null
      ...
      function L(h) {
        ...
        this.raiseEvent("canvas-double-click", _), !_.preventDefaultAction && this.viewport && (g = this.gestureSettingsByDeviceType(h.pointerType), g.dblClickToZoom && (this.viewport.zoomBy(
          h.shift ? 1 / this.zoomPerClick : this.zoomPerClick,
          g.zoomToRefPoint ? this.viewport.pointFromPixel(h.position, !0) : null
      ...
      function B(h) {
        ...
        if (this.raiseEvent("canvas-drag", _), g = this.gestureSettingsByDeviceType(h.pointerType), !_.preventDefaultAction && this.viewport) {
          if (g.dblClickDragToZoom && t[this.hash].draggingToZoom) {
            var C = Math.pow(this.zoomPerDblClickDrag, h.delta.y / 50);
            this.viewport.zoomBy(C);
          } else if (g.dragToPan && !t[this.hash].draggingToZoom) {
            if (this.panHorizontal || (h.delta.x = 0), this.panVertical || (h.delta.y = 0), this.viewport.flipped && (h.delta.x = -h.delta.x), this.constrainDuringPan) {
              var D = this.viewport.deltaPointsFromPixels(h.delta.negate());
              ...
              this.viewport.centerSpringX.target.value -= D.x, this.viewport.centerSpringY.target.value -= D.y, O.xConstrained && (h.delta.x = 0), O.yConstrained && (h.delta.y = 0);
            }
            this.viewport.panBy(this.viewport.deltaPointsFromPixels(h.delta.negate()), g.flickEnabled && !this.constrainDuringPan);
          }
        }
      }
      function z(h) {
        ...
        if (this.raiseEvent("canvas-drag-end", _), g = this.gestureSettingsByDeviceType(h.pointerType), !_.preventDefaultAction && this.viewport) {
          if (!t[this.hash].draggingToZoom && g.dragToPan && g.flickEnabled && h.speed >= g.flickMinSpeed) {
            var C = 0;
            this.panHorizontal && (C = g.flickMomentum * h.speed * Math.cos(h.direction));
            var D = 0;
            this.panVertical && (D = g.flickMomentum * h.speed * Math.sin(h.direction));
            var O = this.viewport.pixelFromPoint(
              this.viewport.getCenter(!0)
            ), R = this.viewport.pointFromPixel(
              new e.Point(O.x - C, O.y - D)
            );
      ...
      function G(h) {
        ...
        if (this.raiseEvent("canvas-press", {
          ...
          position: h.position,
          insideElementPressed: h.insideElementPressed,
          insideElementReleased: h.insideElementReleased,
          originalEvent: h.originalEvent
        }), g = this.gestureSettingsByDeviceType(h.pointerType), g.dblClickDragToZoom) {
          var _ = t[this.hash].lastClickTime, C = e.now();
          if (_ === null)
            return;
          C - _ < this.dblClickTimeThreshold && (t[this.hash].draggingToZoom = !0), t[this.hash].lastClickTime = null;
        }
      }
      function K(h) {
      ...
      function X(h) {
        var g, _, C, D, O = {
          tracker: h.eventSource,
          pointerType: h.pointerType,
          gesturePoints: h.gesturePoints,
          lastCenter: h.lastCenter,
          center: h.center,
          lastDistance: h.lastDistance,
          distance: h.distance,
          shift: h.shift,
          originalEvent: h.originalEvent,
        ...
        if (this.raiseEvent("canvas-pinch", O), this.viewport && (g = this.gestureSettingsByDeviceType(h.pointerType), g.pinchToZoom && (!O.preventDefaultPanAction || !O.preventDefaultZoomAction) && (_ = this.viewport.pointFromPixel(h.center, !0), g.zoomToRefPoint && !O.preventDefaultPanAction && (C = this.viewport.pointFromPixel(h.lastCenter, !0), D = C.minus(_), this.panHorizontal || (D.x = 0), this.panVertical || (D.y = 0), this.viewport.panBy(D, !0)), O.preventDefaultZoomAction || this.viewport.zoomBy(h.distance / h.lastDistance, _, !0), this.viewport.applyConstraints()), g.pinchRotate && !O.preventDefaultRotateAction)) {
          var R = Math.atan2(
            h.gesturePoints[0].currentPos.y - h.gesturePoints[1].currentPos.y,
            h.gesturePoints[0].currentPos.x - h.gesturePoints[1].currentPos.x
          ), M = Math.atan2(
            h.gesturePoints[0].lastPos.y - h.gesturePoints[1].lastPos.y,
            h.gesturePoints[0].lastPos.x - h.gesturePoints[1].lastPos.x
          );
          _ = this.viewport.pointFromPixel(h.center, !0), this.viewport.rotateTo(this.viewport.getRotation(!0) + (R - M) * (180 / Math.PI), _, !0);
        }
      }
      function ee(h) {
      ...
      function $(h) {
        var g, _, C, D, O;
        D = e.now(), O = D - this._lastScrollTime, O > this.minScrollDeltaTime ? (this._lastScrollTime = D, g = {
          tracker: h.eventSource,
          position: h.position,
          scroll: h.scroll,
          shift: h.shift,
          ...
          preventDefaultAction: !1,
          preventDefault: !0
        }, this.raiseEvent("canvas-scroll", g), !g.preventDefaultAction && this.viewport && (this.viewport.flipped && (h.position.x = this.viewport.getContainerSize().x - h.position.x), _ = this.gestureSettingsByDeviceType(h.pointerType), _.scrollToZoom && (C = Math.pow(this.zoomPerScroll, h.scroll), this.viewport.zoomBy(
          C,
          _.zoomToRefPoint ? this.viewport.pointFromPixel(h.position, !0) : null
        ), this.viewport.applyConstraints())), h.preventDefault = g.preventDefault) : h.preventDefault = !0;
      }
      function ie(h) {
        t[this.hash].mouseInside = !0, m(this), this.raiseEvent("container-enter", {
          tracker: h.eventSource,
          pointerType: h.pointerType,
          position: h.position,
          buttons: h.buttons,
      ...
      function te(h) {
        h.pointers < 1 && (t[this.hash].mouseInside = !1, t[this.hash].animating || u(this)), this.raiseEvent("container-exit", {
          tracker: h.eventSource,
          pointerType: h.pointerType,
          position: h.position,
          buttons: h.buttons,
      ...
      function se(h) {
        we(h), h.isOpen() ? h._updateRequestId = o(h, se) : h._updateRequestId = !1;
      }
      function oe(h, g) {
        var _ = h.viewport, C = _.getZoom(), D = _.getCenter();
        _.resize(g, h.preserveImageSizeOnResize), _.panTo(D, !0);
        var O;
        if (h.preserveImageSizeOnResize)
          O = t[h.hash].prevContainerSize.x / g.x;
        else {
          var R = new e.Point(0, 0), M = new e.Point(t[h.hash].prevContainerSize.x, t[h.hash].prevContainerSize.y).distanceTo(R), V = new e.Point(g.x, g.y).distanceTo(R);
          O = V / M * t[h.hash].prevContainerSize.x / g.x;
        }
        _.zoomTo(C * O, null, !0), t[h.hash].prevContainerSize = g, t[h.hash].forceRedraw = !0, t[h.hash].needsResize = !1, t[h.hash].forceResize = !1;
      }
      function we(h) {
        if (!(h._opening || !t[h.hash])) {
          if (h.autoResize || t[h.hash].forceResize) {
            var g;
            if (h._autoResizePolling) {
              g = i(h.container);
              var _ = t[h.hash].prevContainerSize;
              g.equals(_) || (t[h.hash].needsResize = !0);
            }
            t[h.hash].needsResize && oe(h, g || i(h.container));
          }
          var C = h.viewport.update(), D = h.world.update(C) || C;
          C && h.raiseEvent("viewport-change"), h.referenceStrip && (D = h.referenceStrip.update(h.viewport) || D);
          var O = t[h.hash].animating;
          !O && D && (h.raiseEvent("animation-start"), m(h));
          var R = O && !D;
          R && (t[h.hash].animating = !1), (D || R || t[h.hash].forceRedraw || h.world.needsDraw()) && (Te(h), h._drawOverlays(), h.navigator && h.navigator.update(h.viewport), t[h.hash].forceRedraw = !1, D && h.raiseEvent("animation")), R && (h.raiseEvent("animation-finish"), t[h.hash].mouseInside || u(h)), t[h.hash].animating = D;
        }
      }
      function Te(h) {
        h.imageLoader.clear(), h.world.draw(), h.raiseEvent("update-viewport", {});
      }
      function k(h, g) {
        return h ? h + g : g;
      }
      function ce() {
        t[this.hash].lastZoomTime = e.now(), t[this.hash].zoomFactor = this.zoomPerSecond, t[this.hash].zooming = !0, ae(this);
      }
      function de() {
        t[this.hash].lastZoomTime = e.now(), t[this.hash].zoomFactor = 1 / this.zoomPerSecond, t[this.hash].zooming = !0, ae(this);
      }
      function pe() {
        t[this.hash].zooming = !1;
      }
      function ae(h) {
        e.requestAnimationFrame(e.delegate(h, fe));
      }
      function fe() {
        var h, g, _;
        t[this.hash].zooming && this.viewport && (h = e.now(), g = h - t[this.hash].lastZoomTime, _ = Math.pow(t[this.hash].zoomFactor, g / 1e3), this.viewport.zoomBy(_), this.viewport.applyConstraints(), t[this.hash].lastZoomTime = h, ae(this));
      }
      function xe() {
      ...
      function Ee() {
        if (this.viewport) {
          var h = this.viewport.getRotation();
          this.viewport.flipped ? h += this.rotationIncrement : h -= this.rotationIncrement, this.viewport.setRotation(h);
        }
      }
      function ue() {
        if (this.viewport) {
      ...
      e.determineDrawer = function(h) {
        for (let g in F) {
          const _ = F[g], C = _.prototype;
          if (C && C instanceof F.DrawerBase && e.isFunction(C.getType) && C.getType.call(_) === h)
            return _;
        }
        return null;
      };
      ...
      e.Navigator = function(o) {
        ...
        o.element || o.id ? (o.element ? (o.id && e.console.warn("Given option.id for Navigator was ignored since option.element was provided and is being used instead."), o.element.id ? o.id = o.element.id : o.id = "navigator-" + e.now(), this.element = o.element) : this.element = document.getElementById(o.id), o.controlOptions = {
        ...
        }), o.minPixelRatio = this.minPixelRatio = l.minPixelRatio, e.setElementTouchActionNone(this.element), this.borderWidth = 2, this.fudge = new e.Point(1, 1), this.totalBorderWidths = new e.Point(this.borderWidth * 2, this.borderWidth * 2).minus(this.fudge), o.controlOptions.anchor !== e.ControlAnchor.NONE && (function(T, x) {
          T.margin = "0px", T.border = x + "px solid " + o.borderColor, T.padding = "0px", T.background = o.background, T.opacity = o.opacity, T.overflow = "hidden";
          ...
          T.position = "relative", T.top = "0px", T.left = "0px", T.fontSize = "0px", T.overflow = "hidden", T.border = x + "px solid " + o.displayRegionColor, T.margin = "0px", T.padding = "0px", T.background = "transparent", T.float = "left", T.cssFloat = "left", T.zIndex = 999999999, T.cursor = "default", T.boxSizing = "content-box";
          ...
          this.element,
          o.controlOptions
        ), this._resizeWithViewer = o.controlOptions.anchor !== e.ControlAnchor.ABSOLUTE && o.controlOptions.anchor !== e.ControlAnchor.NONE, o.width && o.height ? (this.setWidth(o.width), this.setHeight(o.height)) : this._resizeWithViewer && (p = e.getElementSize(l.element), this.element.style.height = Math.round(p.y * o.sizeRatio) + "px", this.element.style.width = Math.round(p.x * o.sizeRatio) + "px", this.oldViewerSize = p, m = e.getElementSize(this.element), this.elementArea = m.x * m.y), this.oldContainerSize = new e.Point(0, 0), e.Viewer.apply(this, [o]), this.displayRegionContainer.appendChild(this.displayRegion), this.element.getElementsByTagName("div")[0].appendChild(this.displayRegionContainer);
        function w(T, x) {
          a(u.displayRegionContainer, T), a(u.displayRegion, -T), u.viewport.setRotation(T, x);
        }
        if (o.navigatorRotate) {
          var y = o.viewer.viewport ? o.viewer.viewport.getRotation() : o.viewer.degrees || 0;
          w(y, !0), o.viewer.addHandler("rotate", function(T) {
            w(T.degrees, T.immediately);
          });
        }
        this.innerTracker.destroy(), this.innerTracker = new e.MouseTracker({
          ...
          preProcessEventHandler: function(T) {
            T.eventType === "wheel" && (T.preventDefault = !0);
          }
          ...
          u.viewport && u.viewport.goHome(!0);
        }), l.world.addHandler("item-index-change", function(T) {
          window.setTimeout(function() {
            var x = u.world.getItemAt(T.previousIndex);
            u.world.setItemIndex(x, T.newIndex);
          }, 1);
        }), l.world.addHandler("remove-item", function(T) {
          var x = T.item, E = u._getMatchingItem(x);
          E && u.world.removeItem(E);
        ...
        /** @lends OpenSeadragon.Navigator.prototype */
        {
           ...
           */
          setWidth: function(o) {
            this.width = o, this.element.style.width = typeof o == "number" ? o + "px" : o, this._resizeWithViewer = !1, this.updateSize();
          },
          /**
          ...
          setHeight: function(o) {
            this.height = o, this.element.style.height = typeof o == "number" ? o + "px" : o, this._resizeWithViewer = !1, this.updateSize();
          },
          /**
            ...
            */
          setFlip: function(o) {
            return this.viewport.setFlip(o), this.setDisplayTransform(this.viewer.viewport.getFlip() ? "scale(-1,1)" : "scale(1,1)"), this;
          },
          setDisplayTransform: function(o) {
            s(this.canvas, o), s(this.element, o);
          },
          /**
          ...
          update: function(o) {
            var l, u, p, m, w, y;
            if (o || (o = this.viewer.viewport), l = e.getElementSize(this.viewer.element), this._resizeWithViewer && l.x && l.y && !l.equals(this.oldViewerSize) && (this.oldViewerSize = l, this.maintainSizeRatio || !this.elementArea ? (u = l.x * this.sizeRatio, p = l.y * this.sizeRatio) : (u = Math.sqrt(this.elementArea * (l.x / l.y)), p = this.elementArea / u), this.element.style.width = Math.round(u) + "px", this.element.style.height = Math.round(p) + "px", this.elementArea || (this.elementArea = u * p), this.updateSize()), o && this.viewport) {
              if (m = o.getBoundsNoRotate(!0), w = this.viewport.pixelFromPointNoRotate(m.getTopLeft(), !1), y = this.viewport.pixelFromPointNoRotate(m.getBottomRight(), !1).minus(this.totalBorderWidths), !this.navigatorRotate) {
                var T = o.getRotation(!0);
                a(this.displayRegion, -T);
              }
              var x = this.displayRegion.style;
              x.display = this.world.getItemCount() ? "block" : "none", x.top = w.y.toFixed(2) + "px", x.left = w.x.toFixed(2) + "px";
              var E = y.x - w.x, P = y.y - w.y;
              x.width = Math.round(Math.max(E, 0)) + "px", x.height = Math.round(Math.max(P, 0)) + "px";
            }
          },
          // overrides Viewer.addTiledImage
          addTiledImage: function(o) {
            var l = this, u = o.originalTiledImage;
            delete o.original;
            var p = e.extend({}, o, {
              success: function(m) {
                var w = m.item;
                w._originalForNavigator = u, l._matchBounds(w, u, !0), l._matchOpacity(w, u), l._matchCompositeOperation(w, u);
                function y() {
                  l._matchBounds(w, u);
                }
                function T() {
                ...
                function x() {
                  l._matchCompositeOperation(w, u);
                }
                u.addHandler("bounds-change", y), u.addHandler("clip-change", y), u.addHandler("opacity-change", T), u.addHandler("composite-operation-change", x);
              }
            });
          ...
          // private
          _getMatchingItem: function(o) {
            for (var l = this.world.getItemCount(), u, p = 0; p < l; p++)
              if (u = this.world.getItemAt(p), u._originalForNavigator === o)
                return u;
            return null;
          },
          // private
          _matchBounds: function(o, l, u) {
            var p = l.getBoundsNoRotate();
            o.setPosition(p.getTopLeft(), u), o.setWidth(p.width, u), o.setRotation(l.getRotation(), u), o.setClip(l.getClip()), o.setFlip(l.getFlip());
          },
          // private
          _matchOpacity: function(o, l) {
            o.setOpacity(l.opacity);
          },
          // private
          _matchCompositeOperation: function(o, l) {
            o.setCompositeOperation(l.compositeOperation);
          }
        }
      );
      function t(o) {
        var l = {
          tracker: o.eventSource,
          position: o.position,
          quick: o.quick,
          shift: o.shift,
        ...
        if (this.viewer.raiseEvent("navigator-click", l), !l.preventDefaultAction && o.quick && this.viewer.viewport && (this.panVertical || this.panHorizontal)) {
          this.viewer.viewport.flipped && (o.position.x = this.viewport.getContainerSize().x - o.position.x);
          var u = this.viewport.pointFromPixel(o.position);
          this.panVertical ? this.panHorizontal || (u.x = this.viewer.viewport.getCenter(!0).x) : u.y = this.viewer.viewport.getCenter(!0).y, this.viewer.viewport.panTo(u), this.viewer.viewport.applyConstraints();
        }
      }
      function r(o) {
        var l = {
        ...
        this.viewer.raiseEvent("navigator-drag", l), !l.preventDefaultAction && this.viewer.viewport && (this.panHorizontal || (o.delta.x = 0), this.panVertical || (o.delta.y = 0), this.viewer.viewport.flipped && (o.delta.x = -o.delta.x), this.viewer.viewport.panBy(
      ...
      function i(o) {
        o.insideElementPressed && this.viewer.viewport && this.viewer.viewport.applyConstraints();
      }
      function n(o) {
        var l = {
          tracker: o.eventSource,
        ...
        this.viewer.raiseEvent("navigator-scroll", l), o.preventDefault = l.preventDefault;
      }
      function a(o, l) {
        s(o, "rotate(" + l + "deg)");
      }
      ...
      e.extend(
        ...
        /** @lends OpenSeadragon */
        {
          ...
          getString: function(r) {
            var i = r.split("."), n = null, a = arguments, s = t, o;
            for (o = 0; o < i.length - 1; o++)
              s = s[i[o]] || {};
            return n = s[i[o]], typeof n != "string" && (e.console.error("Untranslated source string:", r), n = ""), n.replace(/\{\d+\}/g, function(l) {
              var u = parseInt(l.match(/\d+/), 10) + 1;
              return u < a.length ? a[u] : "";
            });
          },
          /**
           * @function
      ...
      e.Point = function(t, r) {
        ...
        rotate: function(t, r) {
          ...
          var o = i * (this.x - r.x) - n * (this.y - r.y) + r.x, l = n * (this.x - r.x) + i * (this.y - r.y) + r.y;
      ...
      e.TileSource = function(r, i, n, a, s, o) {
        var l = this, u = arguments, p, m;
        if (e.isPlainObject(r) ? p = r : p = {
          width: u[0],
          height: u[1],
          tileSize: u[2],
          tileOverlap: u[3],
        ...
        getNumTiles: function(r) {
          var i = this.getLevelScale(r), n = Math.ceil(i * this.dimensions.x / this.getTileWidth(r)), a = Math.ceil(i * this.dimensions.y / this.getTileHeight(r));
          return new e.Point(n, a);
        },
        /**
         * @function
         * @param {Number} level
        ...
        getPixelRatio: function(r) {
          var i = this.dimensions.times(this.getLevelScale(r)), n = 1 / i.x * e.pixelDensityRatio, a = 1 / i.y * e.pixelDensityRatio;
          return new e.Point(n, a);
        },
        /**
         * @function
        ...
        getTileAtPoint: function(r, i) {
          ...
          var a = this.dimensions.x * this.getLevelScale(r), s = i.x * a, o = i.y * a, l = Math.floor(s / this.getTileWidth(r)), u = Math.floor(o / this.getTileHeight(r));
          i.x >= 1 && (l = this.getNumTiles(r).x - 1);
          var p = 1e-15;
          return i.y >= 1 / this.aspectRatio - p && (u = this.getNumTiles(r).y - 1), new e.Point(l, u);
        },
        /**
         * @function
         * @param {Number} level
         ...
         */
        getTileBounds: function(r, i, n, a) {
          var s = this.dimensions.times(this.getLevelScale(r)), o = this.getTileWidth(r), l = this.getTileHeight(r), u = i === 0 ? 0 : o * i - this.tileOverlap, p = n === 0 ? 0 : l * n - this.tileOverlap, m = o + (i === 0 ? 1 : 2) * this.tileOverlap, w = l + (n === 0 ? 1 : 2) * this.tileOverlap, y = 1 / s.x;
          return m = Math.min(m, s.x - u), w = Math.min(w, s.y - p), a ? new e.Rect(0, 0, m, w) : new e.Rect(u * y, p * y, m * y, w * y);
        },
        /**
        ...
        getImageInfo: function(r) {
          var i = this, n, a, s, o, l, u, p;
          r && (l = r.split("/"), u = l[l.length - 1], p = u.lastIndexOf("."), p > -1 && (l[l.length - 1] = u.slice(0, p)));
          var m = null;
          if (this.splitHashDataForPost) {
            var w = r.indexOf("#");
            w !== -1 && (m = r.substring(w + 1), r = r.substr(0, w));
          }
          a = function(y) {
            typeof y == "string" && (y = e.parseXml(y));
            var T = e.TileSource.determineType(i, y, r);
            if (!T) {
              i.raiseEvent("open-failed", { message: "Unable to load TileSource", source: r });
              return;
            }
            o = T.prototype.configure.apply(i, [y, r, m]), o.ajaxWithCredentials === void 0 && (o.ajaxWithCredentials = i.ajaxWithCredentials), s = new T(o), i.ready = !0, i.raiseEvent("ready", { tileSource: s });
            ...
            error: function(y, T) {
              ...
              e.console.error(x), i.raiseEvent("open-failed", {
                message: x,
                source: r,
                postData: m
              });
         ...
         */
        getTileHashKey: function(r, i, n, a, s, o) {
          function l(u) {
            return s ? u + "+" + JSON.stringify(s) : u;
          }
          return l(typeof a != "string" ? r + "/" + i + "_" + n : a);
        },
        /**
         * @function
         * @param {Number} level
        ...
        tileExists: function(r, i, n) {
          ...
          return r >= this.minLevel && r <= this.maxLevel && i >= 0 && n >= 0 && i < a.x && n < a.y;
        },
        /**
         * Decide whether tiles have transparency: this is crucial for correct images blending.
         * @returns {boolean} true if the image has transparency
         */
        hasTransparency: function(r, i, n, a) {
          ...
          n.onload = function() {
            ...
            success: function(s) {
              ...
              try {
                ...
                if (p.name === "TypeError" && l) {
                  var u = new l();
                  u.append(s.response), o = u.getBlob();
                }
              }
              o.size === 0 ? a("Empty image response.") : n.src = (window.URL || window.webkitURL).createObjectURL(o);
            },
            error: function(s) {
      ...
      function t(r) {
        var i = r.responseText, n = r.status, a, s;
        if (r) {
          if (r.status !== 200 && r.status !== 0)
            throw n = r.status, a = n === 404 ? "Not Found" : r.statusText, new Error(e.getString("Errors.Status", n, a));
      ...
      e.TileSource.determineType = function(r, i, n) {
        var a;
        for (a in F)
          if (a.match(/.+TileSource$/) && e.isFunction(F[a]) && e.isFunction(F[a].prototype.supports) && F[a].prototype.supports.call(r, i, n))
            return F[a];
        return e.console.error("No TileSource was able to open %s %s", n, i), null;
      };
    })(F), (function(e) {
      e.DziTileSource = function(i, n, a, s, o, l, u, p, m) {
        var w, y, T, x;
        if (e.isPlainObject(i) ? x = i : x = {
          ...
          for (w = this.displayRects.length - 1; w >= 0; w--)
            for (y = this.displayRects[w], T = y.minLevel; T <= y.maxLevel; T++)
              this._levelRects[T] || (this._levelRects[T] = []), this._levelRects[T].push(y);
        ...
        /** @lends OpenSeadragon.DziTileSource.prototype */
        {
          ...
          supports: function(i, n) {
            var a;
            return i.Image ? a = i.Image.xmlns : i.documentElement && (i.documentElement.localName === "Image" || i.documentElement.tagName === "Image") && (a = i.documentElement.namespaceURI), a = (a || "").toLowerCase(), a.indexOf("schemas.microsoft.com/deepzoom/2008") !== -1 || a.indexOf("schemas.microsoft.com/deepzoom/2009") !== -1;
          },
          /**
           *
           * @function
           ...
           * @param {Number} y
           */
          getTileUrl: function(i, n, a) {
            return [this.tilesUrl, i, "/", n, "_", a, ".", this.fileFormat, this.queryParams].join("");
          },
          /**
           * @function
           * @param {Number} level
           ...
           * @param {Number} y
           */
          tileExists: function(i, n, a) {
            var s = this._levelRects[i], o, l, u, p, m, w, y;
            if (this.minLevel && i < this.minLevel || this.maxLevel && i > this.maxLevel)
              return !1;
            if (!s || !s.length)
              return !0;
            for (y = s.length - 1; y >= 0; y--)
              if (o = s[y], !(i < o.minLevel || i > o.maxLevel) && (l = this.getLevelScale(i), u = o.x * l, p = o.y * l, m = u + o.width * l, w = p + o.height * l, u = Math.floor(u / this._tileWidth), p = Math.floor(p / this._tileWidth), m = Math.ceil(m / this._tileWidth), w = Math.ceil(w / this._tileWidth), u <= n && n < m && p <= a && a < w))
                return !0;
            return !1;
          }
        }
      ...
      function t(i, n) {
        ...
        var a = n.documentElement, s = a.localName || a.tagName, o = n.documentElement.namespaceURI, l = null, u = [], p, m, w, y, T;
        if (s === "Image")
          try {
            if (y = a.getElementsByTagName("Size")[0], y === void 0 && (y = a.getElementsByTagNameNS(o, "Size")[0]), l = {
              Image: {
            ...
            for (p = a.getElementsByTagName("DisplayRect"), p === void 0 && (p = a.getElementsByTagNameNS(o, "DisplayRect")[0]), T = 0; T < p.length; T++)
              m = p[T], w = m.getElementsByTagName("Rect")[0], w === void 0 && (w = m.getElementsByTagNameNS(o, "Rect")[0]), u.push({
                Rect: {
                  ...
                  MinLevel: parseInt(m.getAttribute("MinLevel"), 10),
                  MaxLevel: parseInt(m.getAttribute("MaxLevel"), 10)
                }
              });
            return u.length && (l.Image.DisplayRect = u), r(i, l);
          } catch (P) {
            throw P instanceof Error ? P : new Error(e.getString("Errors.Dzi"));
          }
        else {
          if (s === "Collection")
            throw new Error(e.getString("Errors.Dzc"));
          if (s === "Error") {
            var x = a.getElementsByTagName("Message")[0], E = x.firstChild.nodeValue;
            throw new Error(E);
          }
        }
      ...
      function r(i, n) {
        var a = n.Image, s = a.Url, o = a.Format, l = a.Size, u = a.DisplayRect || [], p = parseInt(l.Width, 10), m = parseInt(l.Height, 10), w = parseInt(a.TileSize, 10), y = parseInt(a.Overlap, 10), T = [], x, E;
        for (E = 0; E < u.length; E++)
          x = u[E].Rect, T.push(new e.DisplayRect(
            parseInt(x.X, 10),
            parseInt(x.Y, 10),
            parseInt(x.Width, 10),
      ...
      e.IIIFTileSource = function(a) {
        ...
        if (a.tileSizePerScaleFactor = {}, this.tileFormat = this.tileFormat || "jpg", this.version = a.version, this.tile_width && this.tile_height)
          ...
          if (this.tiles.length === 1)
            ...
            for (var s = 0; s < this.tiles.length; s++)
              for (var o = 0; o < this.tiles[s].scaleFactors.length; o++) {
                var l = this.tiles[s].scaleFactors[o];
                this.scale_factors.push(l), a.tileSizePerScaleFactor[l] = {
          ...
          for (var u = Math.min(this.height, this.width), p = [256, 512, 1024], m = [], w = 0; w < p.length; w++)
            p[w] <= u && m.push(p[w]);
          m.length > 0 ? a.tileSize = Math.max.apply(null, m) : a.tileSize = u;
        } else this.sizes && this.sizes.length > 0 ? (this.emulateLegacyImagePyramid = !0, a.levels = r(this), e.extend(!0, a, {
        ...
        if (!a.maxLevel && !this.emulateLegacyImagePyramid)
          if (!this.scale_factors)
            ...
            a.maxLevel = Math.round(Math.log(y) * Math.LOG2E);
          }
        if (this.sizes) {
          var T = this.sizes.length;
          (T === a.maxLevel || T === a.maxLevel + 1) && (this.levelSizes = this.sizes.slice().sort((x, E) => x.width - E.width), T === a.maxLevel && this.levelSizes.push({ width: this.width, height: this.height }));
        }
        ...
        /** @lends OpenSeadragon.IIIFTileSource.prototype */
        {
           ...
           * }
           */
          configure: function(a, s, o) {
            if (e.isPlainObject(a)) {
              if (!a["@context"])
                a["@context"] = "http://iiif.io/api/image/1.0/context.json", a["@id"] = s.replace("/info.json", ""), a.version = 1;
              else {
                var u = a["@context"];
                if (Array.isArray(u)) {
                  for (var p = 0; p < u.length; p++)
                    if (typeof u[p] == "string" && (/^http:\/\/iiif\.io\/api\/image\/[1-3]\/context\.json$/.test(u[p]) || u[p] === "http://library.stanford.edu/iiif/image-api/1.1/context.json")) {
                      u = u[p];
                      break;
                    }
                }
              ...
              if (a.preferredFormats) {
                for (var m = 0; m < a.preferredFormats.length; m++)
                  if (F.imageFormatSupported(a.preferredFormats[m])) {
                    a.tileFormat = a.preferredFormats[m];
                    break;
                  }
              }
              return a;
          ...
          getTileWidth: function(a) {
            ...
            var s = Math.pow(2, this.maxLevel - a);
          ...
          getLevelScale: function(a) {
            if (this.emulateLegacyImagePyramid) {
              var s = NaN;
              return this.levels.length > 0 && a >= this.minLevel && a <= this.maxLevel && (s = this.levels[a].width / this.levels[this.maxLevel].width), s;
            }
          ...
          getNumTiles: function(a) {
            if (this.emulateLegacyImagePyramid) {
              var s = this.getLevelScale(a);
              return s ? new e.Point(1, 1) : new e.Point(0, 0);
            }
            if (this.levelSizes) {
              var o = this.levelSizes[a], l = Math.ceil(o.width / this.getTileWidth(a)), u = Math.ceil(o.height / this.getTileHeight(a));
              return new e.Point(l, u);
            } else
          ...
          getTileAtPoint: function(a, s) {
            ...
            if (this.levelSizes) {
              ...
              var l = this.levelSizes[a].width, u = s.x * l, p = s.y * l, m = Math.floor(u / this.getTileWidth(a)), w = Math.floor(p / this.getTileHeight(a));
              s.x >= 1 && (m = this.getNumTiles(a).x - 1);
              var y = 1e-15;
              return s.y >= 1 / this.aspectRatio - y && (w = this.getNumTiles(a).y - 1), new e.Point(m, w);
            }
            return e.TileSource.prototype.getTileAtPoint.call(this, a, s);
          },
          /**
           * Responsible for retrieving the url which will return an image for the
           * region specified by the given x, y, and level components.
      ...
      function t(a) {
        ...
        ], o = Array.isArray(a.profile) ? a.profile[0] : a.profile, l = s.indexOf(o) !== -1, u = !1;
        return a.version === 2 && a.profile.length > 1 && a.profile[1].supports && (u = a.profile[1].supports.indexOf("sizeByW") !== -1), a.version === 3 && a.extraFeatures && (u = a.extraFeatures.indexOf("sizeByWh") !== -1), !l || u;
      }
      function r(a) {
        for (var s = [], o = 0; o < a.sizes.length; o++)
          s.push({
            url: a._id + "/full/" + a.sizes[o].width + "," + (a.version === 3 ? a.sizes[o].height : "") + "/0/default." + a.tileFormat,
            width: a.sizes[o].width,
            height: a.sizes[o].height
          });
        return s.sort(function(l, u) {
      ...
      function i(a) {
        if (!a || !a.documentElement)
          throw new Error(e.getString("Errors.Xml"));
        var s = a.documentElement, o = s.tagName, l = null;
        if (o === "info")
          try {
            return l = {}, n(s, l), l;
          } catch (u) {
            throw u instanceof Error ? u : new Error(e.getString("Errors.IIIF"));
          }
      ...
      function n(a, s, o) {
        var l, u;
        if (a.nodeType === 3 && o)
          u = a.nodeValue.trim(), u.match(/^\d*$/) && (u = Number(u)), s[o] ? (e.isArray(s[o]) || (s[o] = [s[o]]), s[o].push(u)) : s[o] = u;
        else if (a.nodeType === 1)
          for (l = 0; l < a.childNodes.length; l++)
            n(a.childNodes[l], s, a.nodeName);
      }
    })(F), (function(e) {
      e.OsmTileSource = function(t, r, i, n, a) {
        var s;
      ...
      e.TmsTileSource = function(t, r, i, n, a) {
        var s;
        e.isPlainObject(t) ? s = t : s = {
          width: arguments[0],
          height: arguments[1],
        ...
        var o = Math.ceil(s.width / 256) * 256, l = Math.ceil(s.height / 256) * 256, u;
        o > l ? u = o / 256 : u = l / 256, s.maxLevel = Math.ceil(Math.log(u) / Math.log(2)) - 1, s.tileSize = 256, s.width = o, s.height = l, e.TileSource.apply(this, [s]);
      }, e.extend(
      ...
      e.ZoomifyTileSource = function(t) {
        ...
        t.imageSizes.reverse(), t.gridSize.reverse(), t.minLevel = 0, t.maxLevel = t.gridSize.length - 1, F.TileSource.apply(this, [t]);
      }, e.extend(
        ...
        /** @lends OpenSeadragon.ZoomifyTileSource.prototype */
        {
          ...
          _calculateAbsoluteTileNumber: function(t, r, i) {
            for (var n = 0, a = {}, s = 0; s < t; s++)
              a = this.gridSize[s], n += a.x * a.y;
            return a = this.gridSize[t], n += a.x * i + r, n;
          },
          /**
           * Determine if the data and/or url imply the image service is supported by
           * this tile source.
           ...
           */
          getTileUrl: function(t, r, i) {
            var n = 0, a = this._calculateAbsoluteTileNumber(t, r, i);
            return n = Math.floor(a / 256), this.tilesUrl + "TileGroup" + n + "/" + t + "-" + r + "-" + i + "." + this.fileFormat;
          }
        }
      );
    })(F), (function(e) {
      e.LegacyTileSource = function(n) {
        ...
        e.isArray(n) && (a = {
          ...
          levels: n
        }), a.levels = t(a.levels), a.levels.length > 0 ? (s = a.levels[a.levels.length - 1].width, o = a.levels[a.levels.length - 1].height) : (s = 0, o = 0, e.console.error("No supported image formats found")), e.extend(!0, a, {
          width: s,
          height: o,
          tileSize: Math.max(o, s),
          tileOverlap: 0,
          minLevel: 0,
        ...
        /** @lends OpenSeadragon.LegacyTileSource.prototype */
        {
           ...
           *      to configure this tile sources constructor.
           */
          configure: function(n, a, s) {
            var o;
            return e.isPlainObject(n) ? o = i(this, n) : o = r(this, n), o;
          },
          /**
           * @function
           * @param {Number} level
           ...
           * @throws {Error}
           */
          getTileUrl: function(n, a, s) {
            var o = null;
            return this.levels.length > 0 && n >= this.minLevel && n <= this.maxLevel && (o = this.levels[n].url), o;
          }
        }
      );
      function t(n) {
      ...
      function r(n, a) {
        if (!a || !a.documentElement)
          throw new Error(e.getString("Errors.Xml"));
        var s = a.documentElement, o = s.tagName, l = null, u = [], p, m;
        if (o === "image")
          try {
            for (l = {
              type: s.getAttribute("type"),
              levels: []
            }, u = s.getElementsByTagName("level"), m = 0; m < u.length; m++)
              p = u[m], l.levels.push({
      ...
      e.ImageTileSource = function(t) {
        ...
        /** @lends OpenSeadragon.ImageTileSource.prototype */
        {
          ...
          _buildLevels: function() {
            ...
            var r = this._image.naturalWidth, i = this._image.naturalHeight, n = document.createElement("canvas"), a = n.getContext("2d");
            if (n.width = r, n.height = i, a.drawImage(this._image, 0, 0, r, i), t[0].context2D = a, delete this._image, e.isCanvasTainted(n))
              return t;
            for (; r >= 2 && i >= 2; ) {
              r = Math.floor(r / 2), i = Math.floor(i / 2);
              var s = document.createElement("canvas"), o = s.getContext("2d");
              s.width = r, s.height = i, o.drawImage(n, 0, 0, r, i), t.splice(0, 0, {
                context2D: o,
                width: r,
                height: i
              }), n = s, a = o;
      ...
      e.ButtonState = {
        ...
        e.EventSource.call(this), e.extend(!0, this, {
          ...
          onBlur: null,
          userData: null
        }, o), this.element = o.element || e.makeNeutralElement("div"), o.element || (this.imgRest = e.makeTransparentImage(this.srcRest), this.imgGroup = e.makeTransparentImage(this.srcGroup), this.imgHover = e.makeTransparentImage(this.srcHover), this.imgDown = e.makeTransparentImage(this.srcDown), this.imgRest.alt = this.imgGroup.alt = this.imgHover.alt = this.imgDown.alt = this.tooltip, e.setElementPointerEventsNone(this.imgRest), e.setElementPointerEventsNone(this.imgGroup), e.setElementPointerEventsNone(this.imgHover), e.setElementPointerEventsNone(this.imgDown), this.element.style.position = "relative", e.setElementTouchActionNone(this.element), this.imgGroup.style.position = this.imgHover.style.position = this.imgDown.style.position = "absolute", this.imgGroup.style.top = this.imgHover.style.top = this.imgDown.style.top = "0px", this.imgGroup.style.left = this.imgHover.style.left = this.imgDown.style.left = "0px", this.imgHover.style.visibility = this.imgDown.style.visibility = "hidden", this.element.appendChild(this.imgRest), this.element.appendChild(this.imgGroup), this.element.appendChild(this.imgHover), this.element.appendChild(this.imgDown)), this.addHandler("press", this.onPress), this.addHandler("release", this.onRelease), this.addHandler("click", this.onClick), this.addHandler("enter", this.onEnter), this.addHandler("exit", this.onExit), this.addHandler("focus", this.onFocus), this.addHandler("blur", this.onBlur), this.currentState = e.ButtonState.GROUP, this.fadeBeginTime = null, this.shouldFade = !1, this.element.style.display = "inline-block", this.element.style.position = "relative", this.element.title = this.tooltip, this.tracker = new e.MouseTracker({
          userData: "Button.tracker",
          element: this.element,
          clickTimeThreshold: this.clickTimeThreshold,
          clickDistThreshold: this.clickDistThreshold,
          enterHandler: function(u) {
            u.insideElementPressed ? (a(l, e.ButtonState.DOWN), l.raiseEvent("enter", { originalEvent: u.originalEvent })) : u.buttonDownAny || a(l, e.ButtonState.HOVER);
          },
          focusHandler: function(u) {
            l.tracker.enterHandler(u), l.raiseEvent("focus", { originalEvent: u.originalEvent });
          },
          leaveHandler: function(u) {
            s(l, e.ButtonState.GROUP), u.insideElementPressed && l.raiseEvent("exit", { originalEvent: u.originalEvent });
          },
          blurHandler: function(u) {
            l.tracker.leaveHandler(u), l.raiseEvent("blur", { originalEvent: u.originalEvent });
          },
          pressHandler: function(u) {
            a(l, e.ButtonState.DOWN), l.raiseEvent("press", { originalEvent: u.originalEvent });
          },
          releaseHandler: function(u) {
            u.insideElementPressed && u.insideElementReleased ? (s(l, e.ButtonState.HOVER), l.raiseEvent("release", { originalEvent: u.originalEvent })) : u.insideElementPressed ? s(l, e.ButtonState.GROUP) : a(l, e.ButtonState.HOVER);
          },
          clickHandler: function(u) {
            u.quick && l.raiseEvent("click", { originalEvent: u.originalEvent });
          },
          keyHandler: function(u) {
            u.keyCode === 13 ? (l.raiseEvent("click", { originalEvent: u.originalEvent }), l.raiseEvent("release", { originalEvent: u.originalEvent }), u.preventDefault = !0) : u.preventDefault = !1;
          }
      ...
      function r(o) {
        var l, u, p;
        o.shouldFade && (l = e.now(), u = l - o.fadeBeginTime, p = 1 - u / o.fadeLength, p = Math.min(1, p), p = Math.max(0, p), o.imgGroup && e.setElementOpacity(o.imgGroup, p, !0), p > 0 && t(o));
      }
      function i(o) {
        o.shouldFade = !0, o.fadeBeginTime = e.now() + o.fadeDelay, window.setTimeout(function() {
          t(o);
        }, o.fadeDelay);
      }
      function n(o) {
        o.shouldFade = !1, o.imgGroup && e.setElementOpacity(o.imgGroup, 1, !0);
      }
      function a(o, l) {
        o.element.disabled || (l >= e.ButtonState.GROUP && o.currentState === e.ButtonState.REST && (n(o), o.currentState = e.ButtonState.GROUP), l >= e.ButtonState.HOVER && o.currentState === e.ButtonState.GROUP && (o.imgHover && (o.imgHover.style.visibility = ""), o.currentState = e.ButtonState.HOVER), l >= e.ButtonState.DOWN && o.currentState === e.ButtonState.HOVER && (o.imgDown && (o.imgDown.style.visibility = ""), o.currentState = e.ButtonState.DOWN));
      }
      function s(o, l) {
      ...
      e.Rect = function(t, r, i, n, a) {
        this.x = typeof t == "number" ? t : 0, this.y = typeof r == "number" ? r : 0, this.width = typeof i == "number" ? i : 0, this.height = typeof n == "number" ? n : 0, this.degrees = typeof a == "number" ? a : 0, this.degrees = e.positiveModulo(this.degrees, 360);
        var s, o;
        this.degrees >= 270 ? (s = this.getTopRight(), this.x = s.x, this.y = s.y, o = this.height, this.height = this.width, this.width = o, this.degrees -= 270) : this.degrees >= 180 ? (s = this.getBottomRight(), this.x = s.x, this.y = s.y, this.degrees -= 180) : this.degrees >= 90 && (s = this.getBottomLeft(), this.x = s.x, this.y = s.y, o = this.height, this.height = this.width, this.width = o, this.degrees -= 90);
      }, e.Rect.fromSummits = function(t, r, i) {
        var n = t.distanceTo(r), a = t.distanceTo(i), s = r.minus(t), o = Math.atan(s.y / s.x);
        ...
        */
         ...
         */
        union: function(t) {
          var r = this.getBoundingBox(), i = t.getBoundingBox(), n = Math.min(r.x, i.x), a = Math.min(r.y, i.y), s = Math.max(
            r.x + r.width,
            i.x + i.width
          ), o = Math.max(
            r.y + r.height,
        ...
        intersection: function(t) {
          ...
          var u = t.getTopRight();
          this.containsPoint(u, r) && i.push(u);
          var p = t.getBottomLeft();
          this.containsPoint(p, r) && i.push(p);
          var m = t.getBottomRight();
          this.containsPoint(m, r) && i.push(m);
          for (var w = this._getSegments(), y = t._getSegments(), T = 0; T < w.length; T++)
            for (var x = w[T], E = 0; E < y.length; E++) {
              var P = y[E], L = B(
                x[0],
                x[1],
                P[0],
          ...
          function B(N, X, ee, J) {
            var $ = X.minus(N), ie = J.minus(ee), te = -ie.x * $.y + $.x * ie.y;
            if (te === 0)
              return null;
            var se = ($.x * (N.y - ee.y) - $.y * (N.x - ee.x)) / te, oe = (ie.x * (N.y - ee.y) - ie.y * (N.x - ee.x)) / te;
            return -r <= se && se <= 1 - r && -r <= oe && oe <= 1 - r ? new e.Point(N.x + oe * $.x, N.y + oe * $.y) : null;
          }
          if (i.length === 0)
            return null;
          for (var z = i[0].x, U = i[0].x, W = i[0].y, G = i[0].y, K = 1; K < i.length; K++) {
            var Z = i[K];
            Z.x < z && (z = Z.x), Z.x > U && (U = Z.x), Z.y < W && (W = Z.y), Z.y > G && (G = Z.y);
          }
          return new e.Rect(z, W, U - z, G - W);
        },
        // private
        ...
        rotate: function(t, r) {
          if (t = e.positiveModulo(t, 360), t === 0)
            return this.clone();
          r = r || this.getCenter();
          var i = this.getTopLeft().rotate(t, r), n = this.getTopRight().rotate(t, r), a = n.minus(i);
          a = a.apply(function(o) {
            var l = 1e-15;
            return Math.abs(o) < l ? 0 : o;
          });
          var s = Math.atan(a.y / a.x);
          return a.x < 0 ? s += Math.PI : a.y < 0 && (s += 2 * Math.PI), new e.Rect(
            i.x,
            i.y,
            this.width,
            this.height,
        ...
        getBoundingBox: function() {
          if (this.degrees === 0)
            return this.clone();
          var t = this.getTopLeft(), r = this.getTopRight(), i = this.getBottomLeft(), n = this.getBottomRight(), a = Math.min(t.x, r.x, i.x, n.x), s = Math.max(t.x, r.x, i.x, n.x), o = Math.min(t.y, r.y, i.y, n.y), l = Math.max(t.y, r.y, i.y, n.y);
          return new e.Rect(
            a,
            o,
            s - a,
        ...
        getIntegerBoundingBox: function() {
          var t = this.getBoundingBox(), r = Math.floor(t.x), i = Math.floor(t.y), n = Math.ceil(t.width + t.x - r), a = Math.ceil(t.height + t.y - i);
          return new e.Rect(r, i, n, a);
        },
        /**
        ...
        containsPoint: function(t, r) {
          r = r || 0;
          var i = this.getTopLeft(), n = this.getTopRight(), a = this.getBottomLeft(), s = n.minus(i), o = a.minus(i);
          return (t.x - i.x) * s.x + (t.y - i.y) * s.y >= -r && (t.x - n.x) * s.x + (t.y - n.y) * s.y <= r && (t.x - i.x) * o.x + (t.y - i.y) * o.y >= -r && (t.x - a.x) * o.x + (t.y - a.y) * o.y <= r;
        },
        /**
      ...
      e.ReferenceStrip = function(p) {
        var m = this, w = p.viewer, y = e.getElementSize(w.element), T, x, E;
        for (p.id || (p.id = "referencestrip-" + e.now(), this.element = e.makeNeutralElement("div"), this.element.id = p.id, this.element.className = "referencestrip"), p = e.extend(!0, {
          ...
          animating: !1
        }, this.minPixelRatio = this.viewer.minPixelRatio, this.element.tabIndex = 0, x = this.element.style, x.marginTop = "0px", x.marginRight = "0px", x.marginBottom = "0px", x.marginLeft = "0px", x.left = "0px", x.bottom = "0px", x.border = "0px", x.background = "#000", x.position = "relative", e.setElementTouchActionNone(this.element), e.setElementOpacity(this.element, 0.8), this.viewer = w, this.tracker = new e.MouseTracker({
          ...
          preProcessEventHandler: function(P) {
            P.eventType === "wheel" && (P.preventDefault = !0);
          }
        ...
        )) : p.scroll === "horizontal" ? (this.element.style.width = y.x * p.sizeRatio * w.tileSources.length + 12 * w.tileSources.length + "px", this.element.style.height = y.y * p.sizeRatio + "px", w.addControl(
          this.element,
          { anchor: e.ControlAnchor.BOTTOM_LEFT }
        )) : (this.element.style.height = y.y * p.sizeRatio * w.tileSources.length + 12 * w.tileSources.length + "px", this.element.style.width = y.x * p.sizeRatio + "px", w.addControl(
          this.element,
          { anchor: e.ControlAnchor.TOP_LEFT }
        )), this.panelWidth = y.x * this.sizeRatio + 8, this.panelHeight = y.y * this.sizeRatio + 8, this.panels = [], this.miniViewers = {}, E = 0; E < w.tileSources.length; E++)
          T = e.makeNeutralElement("div"), T.id = this.element.id + "-" + E, T.style.width = m.panelWidth + "px", T.style.height = m.panelHeight + "px", T.style.display = "inline", T.style.float = "left", T.style.cssFloat = "left", T.style.padding = "2px", e.setElementTouchActionNone(T), e.setElementPointerEventsNone(T), this.element.appendChild(T), T.activePanel = !1, this.panels.push(T);
        a(this, this.scroll === "vertical" ? y.y : y.x, 0), this.setFocus(0);
      }, e.ReferenceStrip.prototype = {
        /**
         * @function
         */
        setFocus: function(p) {
          var m = this.element.querySelector("#" + this.element.id + "-" + p), w = e.getElementSize(this.viewer.canvas), y = Number(this.element.style.width.replace("px", "")), T = Number(this.element.style.height.replace("px", "")), x = -Number(this.element.style.marginLeft.replace("px", "")), E = -Number(this.element.style.marginTop.replace("px", "")), P;
          this.currentSelected !== m && (this.currentSelected && (this.currentSelected.style.background = "#000"), this.currentSelected = m, this.currentSelected.style.background = "#999", this.scroll === "horizontal" ? (P = Number(p) * (this.panelWidth + 3), P > x + w.x - this.panelWidth ? (P = Math.min(P, y - w.x), this.element.style.marginLeft = -P + "px", a(this, w.x, -P)) : P < x && (P = Math.max(0, P - w.x / 2), this.element.style.marginLeft = -P + "px", a(this, w.x, -P))) : (P = Number(p) * (this.panelHeight + 3), P > E + w.y - this.panelHeight ? (P = Math.min(P, T - w.y), this.element.style.marginTop = -P + "px", a(this, w.y, -P)) : P < E && (P = Math.max(0, P - w.y / 2), this.element.style.marginTop = -P + "px", a(this, w.y, -P))), this.currentPage = p, s.call(this, { eventSource: this.tracker }));
        },
        /**
         * @function
         */
      ...
      function r(p) {
        if (p.quick) {
          var m;
          this.scroll === "horizontal" ? m = Math.floor(p.position.x / (this.panelWidth + 4)) : m = Math.floor(p.position.y / this.panelHeight), this.viewer.goToPage(m);
        }
        this.element.focus();
      }
      function i(p) {
        if (this.dragging = !0, this.element) {
          var m = Number(this.element.style.marginLeft.replace("px", "")), w = Number(this.element.style.marginTop.replace("px", "")), y = Number(this.element.style.width.replace("px", "")), T = Number(this.element.style.height.replace("px", "")), x = e.getElementSize(this.viewer.canvas);
          this.scroll === "horizontal" ? -p.delta.x > 0 ? m > -(y - x.x) && (this.element.style.marginLeft = m + p.delta.x * 2 + "px", a(this, x.x, m + p.delta.x * 2)) : -p.delta.x < 0 && m < 0 && (this.element.style.marginLeft = m + p.delta.x * 2 + "px", a(this, x.x, m + p.delta.x * 2)) : -p.delta.y > 0 ? w > -(T - x.y) && (this.element.style.marginTop = w + p.delta.y * 2 + "px", a(this, x.y, w + p.delta.y * 2)) : -p.delta.y < 0 && w < 0 && (this.element.style.marginTop = w + p.delta.y * 2 + "px", a(this, x.y, w + p.delta.y * 2));
        }
      }
      function n(p) {
        if (this.element) {
          var m = Number(this.element.style.marginLeft.replace("px", "")), w = Number(this.element.style.marginTop.replace("px", "")), y = Number(this.element.style.width.replace("px", "")), T = Number(this.element.style.height.replace("px", "")), x = e.getElementSize(this.viewer.canvas);
          this.scroll === "horizontal" ? p.scroll > 0 ? m > -(y - x.x) && (this.element.style.marginLeft = m - p.scroll * 60 + "px", a(this, x.x, m - p.scroll * 60)) : p.scroll < 0 && m < 0 && (this.element.style.marginLeft = m - p.scroll * 60 + "px", a(this, x.x, m - p.scroll * 60)) : p.scroll < 0 ? w > x.y - T && (this.element.style.marginTop = w + p.scroll * 60 + "px", a(this, x.y, w + p.scroll * 60)) : p.scroll > 0 && w < 0 && (this.element.style.marginTop = w + p.scroll * 60 + "px", a(this, x.y, w + p.scroll * 60)), p.preventDefault = !0;
        }
      }
      function a(p, m, w) {
        var y, T, x, E, P, L;
        for (p.scroll === "horizontal" ? y = p.panelWidth : y = p.panelHeight, T = Math.ceil(m / y) + 5, x = Math.ceil((Math.abs(w) + m) / y) + 1, T = x - T, T = T < 0 ? 0 : T, P = T; P < x && P < p.panels.length; P++)
          if (L = p.panels[P], !L.activePanel) {
            var B, z = p.viewer.tileSources[P];
            ...
            }), e.setElementPointerEventsNone(E.canvas), e.setElementPointerEventsNone(E.container), E.innerTracker.setTracking(!1), E.outerTracker.setTracking(!1), p.miniViewers[L.id] = E, L.activePanel = !0;
          }
      }
      function s(p) {
        var m = p.eventSource.element;
      ...
      function l(p) {
        if (!p.ctrl && !p.alt && !p.meta)
          switch (p.keyCode) {
            case 38:
              n.call(this, { eventSource: this.tracker, position: null, scroll: 1, shift: null }), p.preventDefault = !0;
              break;
            case 40:
              n.call(this, { eventSource: this.tracker, position: null, scroll: -1, shift: null }), p.preventDefault = !0;
              break;
      ...
      e.DisplayRect = function(t, r, i, n, a, s) {
        e.Rect.apply(this, [t, r, i, n]), this.minLevel = a, this.maxLevel = s;
      ...
      e.Tile = function(t, r, i, n, a, s, o, l, u, p, m, w) {
        ...
        getTranslationForEdgeSmoothing: function(t, r, i) {
          var n = Math.max(1, Math.ceil((i.x - r.x) / 2)), a = Math.max(1, Math.ceil((i.y - r.y) / 2));
          return new e.Point(n, a).minus(
      ...
      e.OverlayPlacement = e.Placement, e.OverlayRotationMode = e.freezeObject({
        ...
        drawHTML: function(t, r) {
          ...
          var n = this._getOverlayPositionAndSize(r), a = n.position, s = this.size = n.size, o = "";
          r.overlayPreserveContentDirection && (o = r.flipped ? " scaleX(-1)" : " scaleX(1)");
          var l = r.flipped ? -n.rotate : n.rotate, u = r.flipped ? " scaleX(-1)" : "";
          if (this.onDraw)
            this.onDraw(a, s, this.element);
          else {
            var p = this.style, m = this.element.style;
            m.display = "block", p.left = a.x + "px", p.top = a.y + "px", this.width !== null && (m.width = s.x + "px"), this.height !== null && (m.height = s.y + "px");
            var w = e.getCssPropertyWithVendorPrefix(
              "transformOrigin"
            ), y = e.getCssPropertyWithVendorPrefix(
              "transform"
            );
            w && y && (l && !r.flipped ? (m[y] = "", p[w] = this._getTransformOrigin(), p[y] = "rotate(" + l + "deg)") : !l && r.flipped ? (m[y] = o, p[w] = this._getTransformOrigin(), p[y] = u) : l && r.flipped ? (m[y] = o, p[w] = this._getTransformOrigin(), p[y] = "rotate(" + l + "deg)" + u) : (m[y] = "", p[w] = "", p[y] = "")), p.display = "flex";
          }
        },
        // private
        _getOverlayPositionAndSize: function(t) {
          ...
          if (t.getRotation(!0) && this.rotationMode !== e.OverlayRotationMode.NO_ROTATION)
            if (this.rotationMode === e.OverlayRotationMode.BOUNDING_BOX && this.width !== null && this.height !== null) {
              var a = new e.Rect(r.x, r.y, i.x, i.y), s = this._getBoundingBox(a, t.getRotation(!0));
        ...
        _getSizeInPixels: function(t) {
          ...
          if (this.checkResize && (this.width === null || this.height === null)) {
            ...
            this.width === null && (r = a.x), this.height === null && (i = a.y);
          }
        ...
        getBounds: function(t) {
          ...
          return this.adjust(a, new e.Point(r, i)), this._adjustBoundsForRotation(
            t,
            new e.Rect(a.x, a.y, r, i)
          );
        },
        // private
      ...
      t.DrawerBase = class {
        ...
        viewportToDrawerRectangle(i) {
          var n = this.viewport.pixelFromPointNoRotate(i.getTopLeft(), !0), a = this.viewport.deltaPixelsFromPointsNoRotate(i.getSize(), !0);
          return new e.Rect(
      ...
      class r extends t.DrawerBase {
         ...
         */
        _drawTiles(n) {
          var a = n.getTilesToDraw().map((l) => l.tile);
          if (!(n.opacity === 0 || a.length === 0 && !n.placeholderFillStyle))
            for (var s = a.length - 1; s >= 0; s--) {
              var o = a[s];
              this._drawTile(o), this.viewer && this.viewer.raiseEvent("tile-drawn", {
                tiledImage: n,
                tile: o
              });
            }
      ...
      class r extends t.DrawerBase {
         ...
         */
        _createDrawingElement() {
          let l = e.makeNeutralElement("canvas"), u = this._calculateCanvasSize();
          return l.width = u.x, l.height = u.y, l;
        }
        /**
         * Draws the TiledImages
         */
        ...
        drawDebuggingRect(l) {
          var u = this.context;
          u.save(), u.lineWidth = 2 * e.pixelDensityRatio, u.strokeStyle = this.debugGridColor[0], u.fillStyle = this.debugGridColor[0], u.strokeRect(
         ...
         * @private
         */
        _raiseTileDrawingEvent(l, u, p, m) {
        ...
        _prepareNewFrame() {
          ...
          if ((this.canvas.width !== l.x || this.canvas.height !== l.y) && (this.canvas.width = l.x, this.canvas.height = l.y, this._updateImageSmoothingEnabled(this.context), this.sketchCanvas !== null)) {
            var u = this._calculateSketchCanvasSize();
            this.sketchCanvas.width = u.x, this.sketchCanvas.height = u.y, this._updateImageSmoothingEnabled(this.sketchContext);
          }
          this._clear();
        }
        /**
         ...
         */
        _clear(l, u) {
          var p = this._getContext(l);
          if (u)
            p.clearRect(u.x, u.y, u.width, u.height);
          else {
            var m = p.canvas;
         ...
         */
        _drawTiles(l) {
          var u = l.getTilesToDraw().map((N) => N.tile);
          if (!(l.opacity === 0 || u.length === 0 && !l.placeholderFillStyle)) {
            var p = u[0], m;
            p && (m = l.opacity < 1 || l.compositeOperation && l.compositeOperation !== "source-over" || !l._isBottomItem() && l.source.hasTransparency(p.context2D, p.getUrl(), p.ajaxHeaders, p.postData));
            var w, y, T = this.viewport.getZoom(!0), x = l.viewportToImageZoom(T);
            u.length > 1 && x > l.smoothTileEdgesMinZoom && !l.iOSDevice && l.getRotation(!0) % 360 === 0 && (m = !0, w = p.getScaleForEdgeSmoothing(), y = p.getTranslationForEdgeSmoothing(
              w,
              this._getCanvasSize(!1),
              this._getCanvasSize(!0)
            ));
            var E;
            m && (w || (E = this.viewport.viewportToViewerElementRectangle(
              l.getClippedBounds(!0)
            ).getIntegerBoundingBox(), E = E.times(e.pixelDensityRatio)), this._clear(!0, E)), w || this._setRotations(l, m);
            var P = !1;
            if (l._clip) {
              this._saveContext(m);
              var L = l.imageToViewportRectangle(l._clip, !0);
              L = L.rotate(-l.getRotation(!0), l._getRotationPoint(!0));
              var B = this.viewportToDrawerRectangle(L);
              w && (B = B.times(w)), y && (B = B.translate(y)), this._setClip(B, m), P = !0;
            }
            if (l._croppingPolygons) {
              var z = this;
              P || this._saveContext(m);
              try {
                var U = l._croppingPolygons.map(function(N) {
                  return N.map(function(X) {
                    var ee = l.imageToViewportCoordinates(X.x, X.y, !0).rotate(-l.getRotation(!0), l._getRotationPoint(!0)), J = z.viewportCoordToDrawerCoord(ee);
                    return w && (J = J.times(w)), y && (J = J.plus(y)), J;
                  });
                });
                this._clipWithPolygons(U, m);
              } catch (N) {
                e.console.error(N);
              }
              P = !0;
            ...
            if (l._hasOpaqueTile = !1, l.placeholderFillStyle && l._hasOpaqueTile === !1) {
              let N = this.viewportToDrawerRectangle(l.getBoundsNoRotate(!0));
              w && (N = N.times(w)), y && (N = N.translate(y));
              let X = null;
              typeof l.placeholderFillStyle == "function" ? X = l.placeholderFillStyle(l, this.context) : X = l.placeholderFillStyle, this._drawRectangle(N, X, m);
            }
            var W = s(l.subPixelRoundingForTransparency), G = !1;
            if (W === e.SUBPIXEL_ROUNDING_OCCURRENCES.ALWAYS)
              G = !0;
            else if (W === e.SUBPIXEL_ROUNDING_OCCURRENCES.ONLY_AT_REST) {
              var K = this.viewer && this.viewer.isAnimating();
              G = !K;
            }
            for (var Z = 0; Z < u.length; Z++)
              p = u[Z], this._drawTile(
                p,
                l,
                m,
                w,
            ...
            P && this._restoreContext(m), w || (l.getRotation(!0) % 360 !== 0 && this._restoreRotationChanges(m), this.viewport.getRotation(!0) % 360 !== 0 && this._restoreRotationChanges(m)), m && (w && this._setRotations(l), this.blendSketch({
              opacity: l.opacity,
              scale: w,
              translate: y,
              compositeOperation: l.compositeOperation,
              bounds: E
            }), w && (l.getRotation(!0) % 360 !== 0 && this._restoreRotationChanges(!1), this.viewport.getRotation(!0) % 360 !== 0 && this._restoreRotationChanges(!1))), this._drawDebugInfo(l, u), this._raiseTiledImageDrawnEvent(l, u);
          }
        }
        /**
        ...
        _drawDebugInfo(l, u) {
          if (l.debugMode)
            for (var p = u.length - 1; p >= 0; p--) {
              var m = u[p];
              try {
                this._drawDebugInfoOnTile(m, u.length, p, l);
              } catch (w) {
                e.console.error(w);
              }
            }
         ...
         */
        _clipWithPolygons(l, u) {
          var p = this._getContext(u);
          p.beginPath();
          for (const m of l)
            for (const [w, y] of m.entries())
              p[w === 0 ? "moveTo" : "lineTo"](y.x, y.y);
          p.clip();
        }
        /**
         * Draws the given tile.
         ...
         */
        _drawTile(l, u, p, m, w, y, T) {
          e.console.assert(l, "[Drawer._drawTile] tile is required"), e.console.assert(u, "[Drawer._drawTile] drawingHandler is required");
          var x = this._getContext(p);
          m = m || 1, this._drawTileToCanvas(l, x, u, m, w, y, T);
        }
        /**
         ...
         * @param {OpenSeadragon.TileSource} source - The source specification of the tile.
         */
        _drawTileToCanvas(l, u, p, m, w, y, T) {
          var x = l.position.times(e.pixelDensityRatio), E = l.size.times(e.pixelDensityRatio), P;
          ...
          if (P = l.getCanvasContext(), !l.loaded || !P) {
            e.console.warn(
              "Attempting to draw tile %s when it's not yet loaded.",
              l.toString()
            );
          ...
          u.save(), typeof m == "number" && m !== 1 && (x = x.times(m), E = E.times(m)), w instanceof e.Point && (x = x.plus(w)), u.globalAlpha === 1 && l.hasTransparency && (y && (x.x = Math.round(x.x), x.y = Math.round(x.y), E.x = Math.round(E.x), E.y = Math.round(E.y)), u.clearRect(
            x.x,
            x.y,
            E.x,
            E.y
          )), this._raiseTileDrawingEvent(p, u, l, P);
          var L, B;
          l.sourceBounds ? (L = Math.min(l.sourceBounds.width, P.canvas.width), B = Math.min(l.sourceBounds.height, P.canvas.height)) : (L = P.canvas.width, B = P.canvas.height), u.translate(x.x + E.x / 2, 0), l.flipped && u.scale(-1, 1), u.drawImage(
            P.canvas,
            0,
            0,
            L,
        ...
        _getContext(l) {
          ...
          if (l) {
            if (this.sketchCanvas === null) {
              ...
              var p = this._calculateSketchCanvasSize();
              if (this.sketchCanvas.width = p.x, this.sketchCanvas.height = p.y, this.sketchContext = this.sketchCanvas.getContext("2d"), this.viewport.getRotation() === 0) {
                var m = this;
                this.viewer.addHandler("rotate", function w() {
                  if (m.viewport.getRotation() !== 0) {
                    m.viewer.removeHandler("rotate", w);
        ...
        _setClip(l, u) {
          var p = this._getContext(u);
          p.beginPath(), p.rect(l.x, l.y, l.width, l.height), p.clip();
        }
        // private
        // used to draw a placeholder rectangle
        _drawRectangle(l, u, p) {
          var m = this._getContext(p);
          m.save(), m.fillStyle = u, m.fillRect(l.x, l.y, l.width, l.height), m.restore();
        }
        /**
        ...
        blendSketch(l, u, p, m) {
          ...
          e.isPlainObject(w) || (w = {
            ...
            scale: u,
            translate: p,
            compositeOperation: m
          }), l = w.opacity, m = w.compositeOperation;
          var y = w.bounds;
          if (this.context.save(), this.context.globalAlpha = l, m && (this.context.globalCompositeOperation = m), y)
            ...
            u = w.scale || 1, p = w.translate;
            var T = p instanceof e.Point ? p : new e.Point(0, 0), x = 0, E = 0;
            if (p) {
              var P = this.sketchCanvas.width - this.canvas.width, L = this.sketchCanvas.height - this.canvas.height;
              x = Math.round(P / 2), E = Math.round(L / 2);
            }
            this.context.drawImage(
              this.sketchCanvas,
              T.x - x * u,
              T.y - E * u,
              (this.canvas.width + 2 * x) * u,
              (this.canvas.height + 2 * E) * u,
              -x,
              -E,
              this.canvas.width + 2 * x,
              this.canvas.height + 2 * E
            );
          }
          this.context.restore();
        }
        // private
        _drawDebugInfoOnTile(l, u, p, m) {
          var w = this.viewer.world.getIndexOfItem(m) % this.debugGridColor.length, y = this.context;
          y.save(), y.lineWidth = 2 * e.pixelDensityRatio, y.font = "small-caps bold " + 13 * e.pixelDensityRatio + "px arial", y.strokeStyle = this.debugGridColor[w], y.fillStyle = this.debugGridColor[w], this._setRotations(m), this._viewportFlipped && this._flip({ point: l.position.plus(l.size.divide(2)) }), y.strokeRect(
            l.position.x * e.pixelDensityRatio,
            l.position.y * e.pixelDensityRatio,
            l.size.x * e.pixelDensityRatio,
            l.size.y * e.pixelDensityRatio
          );
          var T = (l.position.x + l.size.x / 2) * e.pixelDensityRatio, x = (l.position.y + l.size.y / 2) * e.pixelDensityRatio;
          y.translate(T, x);
          const E = this.viewport.getRotation(!0);
          y.rotate(Math.PI / 180 * -E), y.translate(-T, -x), l.x === 0 && l.y === 0 && (y.fillText(
          ...
          ), this.viewport.getRotation(!0) % 360 !== 0 && this._restoreRotationChanges(), m.getRotation(!0) % 360 !== 0 && this._restoreRotationChanges(), y.restore();
        }
        // private
         ...
         */
        _getCanvasSize(l) {
          var u = this._getContext(l).canvas;
          return new e.Point(u.width, u.height);
        }
        /**
        ...
        _setRotations(l, u = !1) {
          ...
          this.viewport.getRotation(!0) % 360 !== 0 && (this._offsetForRotation({
            ...
            useSketch: u,
            saveContext: p
          }), p = !1), l.getRotation(!0) % 360 !== 0 && this._offsetForRotation({
        ...
        _offsetForRotation(l) {
          var u = l.point ? l.point.times(e.pixelDensityRatio) : this._getCanvasCenter(), p = this._getContext(l.useSketch);
          p.save(), p.translate(u.x, u.y), p.rotate(Math.PI / 180 * l.degrees), p.translate(-u.x, -u.y);
        }
        // private
        _flip(l) {
          l = l || {};
          var u = l.point ? l.point.times(e.pixelDensityRatio) : this._getCanvasCenter(), p = this._getContext(l.useSketch);
          p.translate(u.x, 0), p.scale(-1, 1), p.translate(-u.x, 0);
        }
        // private
        _restoreRotationChanges(l) {
          var u = this._getContext(l);
          u.restore();
        }
        // private
        _calculateCanvasSize() {
          var l = e.pixelDensityRatio, u = this.viewport.getContainerSize();
          return {
      ...
      function n(o) {
        return o !== e.SUBPIXEL_ROUNDING_OCCURRENCES.ALWAYS && o !== e.SUBPIXEL_ROUNDING_OCCURRENCES.ONLY_AT_REST && o !== e.SUBPIXEL_ROUNDING_OCCURRENCES.NEVER;
      }
      function a(o) {
        return n(o) ? i : o;
      }
      ...
      t.WebGLDrawer = class extends t.DrawerBase {
        ...
        */
        destroy() {
          ...
          let a = i.getExtension("WEBGL_lose_context");
        ...
        */
        static isSupported() {
          let i = document.createElement("canvas"), n = e.isFunction(i.getContext) && i.getContext("webgl"), a = n && n.getExtension("WEBGL_lose_context");
          return a && a.loseContext(), !!n;
        }
        /**
         *
         * @returns 'webgl'
        ...
        */
        draw(i) {
          ...
          }, o = this.viewport.flipped ? -1 : 1, l = e.Mat3.makeTranslation(-s.center.x, -s.center.y), u = e.Mat3.makeScaling(2 / s.bounds.width * o, -2 / s.bounds.height), p = e.Mat3.makeRotation(-s.rotation), m = u.multiply(p).multiply(l);
          ...
          i.forEach((y, T) => {
            if (y.isTainted()) {
              ...
              if (y.placeholderFillStyle && y._hasOpaqueTile === !1 && this._drawPlaceholder(y), x.length === 0 || y.getOpacity() === 0)
                return;
              let E = x[0], P = y.compositeOperation || this.viewer.compositeOperation || y._clip || y._croppingPolygons || y.debugMode, L = P || y.opacity < 1 || E.hasTransparency;
              P && (w && this._outputContext.drawImage(this._renderingCanvas, 0, 0), n.bindFramebuffer(n.FRAMEBUFFER, null), n.clear(n.COLOR_BUFFER_BIT)), n.useProgram(this._firstPass.shaderProgram), L ? (n.bindFramebuffer(n.FRAMEBUFFER, this._glFrameBuffer), n.clear(n.COLOR_BUFFER_BIT)) : n.bindFramebuffer(n.FRAMEBUFFER, null);
              let B = m, z = y.getRotation(!0);
              if (z % 360 !== 0) {
                let N = e.Mat3.makeRotation(-z * Math.PI / 180), X = y.getBoundsNoRotate(!0).getCenter(), ee = e.Mat3.makeTranslation(X.x, X.y), J = e.Mat3.makeTranslation(-X.x, -X.y), $ = ee.multiply(N).multiply(J);
                B = m.multiply($);
              }
        ...
        */
        _applyContext2dPipeline(i, n, a) {
          if (this._outputContext.save(), this._outputContext.globalCompositeOperation = a === 0 ? null : i.compositeOperation || this.viewer.compositeOperation, i._croppingPolygons || i._clip ? (this._renderToClippingCanvas(i), this._outputContext.drawImage(this._clippingCanvas, 0, 0)) : this._outputContext.drawImage(this._renderingCanvas, 0, 0), this._outputContext.restore(), i.debugMode) {
            const s = this.viewer.viewport.getFlip();
            s && this._flip(), this._drawDebugInfo(n, i, s), s && this._flip();
          }
        }
        // private
        _getTileData(i, n, a, s, o, l, u, p, m) {
          let w = a.texture, y = a.position;
          l.set(y, o * 12);
          let T = this._calculateOverlapFraction(i, n), x = i.positionedBounds.width * T.x, E = i.positionedBounds.height * T.y, P = i.positionedBounds.x + (i.x === 0 ? 0 : x), L = i.positionedBounds.y + (i.y === 0 ? 0 : E), B = i.positionedBounds.x + i.positionedBounds.width - (i.isRightMost ? 0 : x), z = i.positionedBounds.y + i.positionedBounds.height - (i.isBottomMost ? 0 : E), U = B - P, W = z - L, G = new e.Mat3([
            U,
            0,
            0,
            0,
          ...
          if (i.flipped) {
            let Z = e.Mat3.makeTranslation(0.5, 0), N = e.Mat3.makeTranslation(-0.5, 0), X = Z.multiply(e.Mat3.makeScaling(-1, 1)).multiply(N);
            G = G.multiply(X);
          }
          let K = s.multiply(G);
          m[o] = i.opacity, u[o] = w, p[o] = K.values;
        }
        // private
        _textureFilter() {
...
`);
          const s = `
            ...
            `;
          let l = this._gl, u = this.constructor.initShaderProgram(l, s, o);
          l.useProgram(u), this._firstPass = {
            shaderProgram: u,
            aOutputPosition: l.getAttribLocation(u, "a_output_position"),
            aTexturePosition: l.getAttribLocation(u, "a_texture_position"),
            aIndex: l.getAttribLocation(u, "a_index"),
            uTransformMatrices: [...Array(this._glNumTextures).keys()].map((w) => l.getUniformLocation(u, `u_matrix_${w}`)),
            uImages: l.getUniformLocation(u, "u_images"),
            uOpacities: l.getUniformLocation(u, "u_opacities"),
          ...
          let p = new Float32Array(i * 12);
          for (let w = 0; w < i; ++w)
            p.set(Float32Array.from(this._unitQuad), w * 12);
          l.bindBuffer(l.ARRAY_BUFFER, this._firstPass.bufferOutputPosition), l.bufferData(l.ARRAY_BUFFER, p, l.STATIC_DRAW), l.enableVertexAttribArray(this._firstPass.aOutputPosition), l.bindBuffer(l.ARRAY_BUFFER, this._firstPass.bufferTexturePosition), l.enableVertexAttribArray(this._firstPass.aTexturePosition), l.bindBuffer(l.ARRAY_BUFFER, this._firstPass.bufferIndex);
          let m = [...Array(this._glNumTextures).keys()].map((w) => Array(6).fill(w)).flat();
          l.bufferData(l.ARRAY_BUFFER, new Float32Array(m), l.STATIC_DRAW), l.enableVertexAttribArray(this._firstPass.aIndex);
        }
        // private
        _makeSecondPassShaderProgram() {
          const i = `
            ...
            `;
          let a = this._gl, s = this.constructor.initShaderProgram(a, i, n);
          a.useProgram(s), this._secondPass = {
            shaderProgram: s,
            aOutputPosition: a.getAttribLocation(s, "a_output_position"),
            aTexturePosition: a.getAttribLocation(s, "a_texture_position"),
            uMatrix: a.getUniformLocation(s, "u_matrix"),
            uImage: a.getUniformLocation(s, "u_image"),
            uOpacityMultiplier: a.getUniformLocation(s, "u_opacity_multiplier"),
        ...
        // private
        _tileReadyHandler(i) {
          let n = i.tile, a = i.tiledImage;
          if (a.isTainted())
            return;
          let s = n.getCanvasContext(), o = s && s.canvas;
          if (!o || e.isCanvasTainted(o)) {
          ...
          if (!this._TextureMap.get(o)) {
            let u = this._gl, p = u.createTexture(), m, w = a.source.tileOverlap, y, T;
            if (n.sourceBounds ? (y = Math.min(n.sourceBounds.width, o.width) / o.width, T = Math.min(n.sourceBounds.height, o.height) / o.height) : (y = 1, T = 1), w > 0) {
              let E = this._calculateOverlapFraction(n, a), P = (n.x === 0 ? 0 : E.x) * y, L = (n.y === 0 ? 0 : E.y) * T, B = (n.isRightMost ? 1 : 1 - E.x) * y, z = (n.isBottomMost ? 1 : 1 - E.y) * T;
              m = this._makeQuadVertexBuffer(P, B, L, z);
            } else y === 1 && T === 1 ? m = this._unitQuad : m = this._makeQuadVertexBuffer(0, y, 0, T);
            let x = {
              texture: p,
              position: m
            };
            this._TextureMap.set(o, x), u.activeTexture(u.TEXTURE0), u.bindTexture(u.TEXTURE_2D, p), u.texParameteri(u.TEXTURE_2D, u.TEXTURE_WRAP_S, u.CLAMP_TO_EDGE), u.texParameteri(u.TEXTURE_2D, u.TEXTURE_WRAP_T, u.CLAMP_TO_EDGE), u.texParameteri(u.TEXTURE_2D, u.TEXTURE_MIN_FILTER, this._textureFilter()), u.texParameteri(u.TEXTURE_2D, u.TEXTURE_MAG_FILTER, this._textureFilter()), this._uploadImageData(s);
          }
        }
        // private
        _calculateOverlapFraction(i, n) {
          let a = n.source.tileOverlap, s = i.sourceBounds.width, o = i.sourceBounds.height, l = (i.x === 0 ? 0 : a) + (i.isRightMost ? 0 : a), u = (i.y === 0 ? 0 : a) + (i.isBottomMost ? 0 : a), p = a / (s + l), m = a / (o + u);
          return {
            x: p,
            y: m
          };
        ...
        // private
        _uploadImageData(i) {
          let n = this._gl, a = i.canvas;
          try {
            if (!a)
              throw i;
            n.texImage2D(n.TEXTURE_2D, 0, n.RGBA, n.RGBA, n.UNSIGNED_BYTE, a);
          } catch (s) {
        ...
        _renderToClippingCanvas(i) {
          ...
          if (i._clip) {
            let a = [
              ...
              let o = i.imageToViewportCoordinates(s.x, s.y, !0).rotate(this.viewer.viewport.getRotation(!0), this.viewer.viewport.getCenter(!0));
              return this.viewportCoordToDrawerCoord(o);
            });
            this._clippingContext.beginPath(), a.forEach((s, o) => {
              this._clippingContext[o === 0 ? "moveTo" : "lineTo"](s.x, s.y);
            }), this._clippingContext.clip(), this._setClip();
          }
          if (i._croppingPolygons) {
            let n = i._croppingPolygons.map((a) => a.map((s) => {
              let o = i.imageToViewportCoordinates(s.x, s.y, !0).rotate(this.viewer.viewport.getRotation(!0), this.viewer.viewport.getCenter(!0));
              return this.viewportCoordToDrawerCoord(o);
            }));
            this._clippingContext.beginPath(), n.forEach((a) => {
              a.forEach((s, o) => {
                this._clippingContext[o === 0 ? "moveTo" : "lineTo"](s.x, s.y);
              });
        ...
        _offsetForRotation(i) {
          var n = i.point ? i.point.times(e.pixelDensityRatio) : this._getCanvasCenter(), a = this._outputContext;
          a.save(), a.translate(n.x, n.y), a.rotate(Math.PI / 180 * i.degrees), a.translate(-n.x, -n.y);
        }
        // private
        _flip(i) {
          i = i || {};
          var n = i.point ? i.point.times(e.pixelDensityRatio) : this._getCanvasCenter(), a = this._outputContext;
          a.translate(n.x, 0), a.scale(-1, 1), a.translate(-n.x, 0);
        }
        // private
        _drawDebugInfo(i, n, a) {
          for (var s = i.length - 1; s >= 0; s--) {
            var o = i[s].tile;
            try {
              this._drawDebugInfoOnTile(o, i.length, s, n, a);
            } catch (l) {
              e.console.error(l);
            }
          }
        ...
        // private
        _drawDebugInfoOnTile(i, n, a, s, o) {
          var l = this.viewer.world.getIndexOfItem(s) % this.debugGridColor.length, u = this.context;
          u.save(), u.lineWidth = 2 * e.pixelDensityRatio, u.font = "small-caps bold " + 13 * e.pixelDensityRatio + "px arial", u.strokeStyle = this.debugGridColor[l], u.fillStyle = this.debugGridColor[l], this._setRotations(s), o && this._flip({ point: i.position.plus(i.size.divide(2)) }), u.strokeRect(
            i.position.x * e.pixelDensityRatio,
            i.position.y * e.pixelDensityRatio,
            i.size.x * e.pixelDensityRatio,
            i.size.y * e.pixelDensityRatio
          );
          var p = (i.position.x + i.size.x / 2) * e.pixelDensityRatio, m = (i.position.y + i.size.y / 2) * e.pixelDensityRatio;
          u.translate(p, m);
          const w = this.viewport.getRotation(!0);
          u.rotate(Math.PI / 180 * -w), u.translate(-p, -m), i.x === 0 && i.y === 0 && (u.fillText(
            "Zoom: " + this.viewport.getZoom(),
            i.position.x * e.pixelDensityRatio,
          ...
          ), this.viewport.getRotation(!0) % 360 !== 0 && this._restoreRotationChanges(), s.getRotation(!0) % 360 !== 0 && this._restoreRotationChanges(), u.restore();
        }
        _drawPlaceholder(i) {
          const n = i.getBounds(!0), a = this.viewportToDrawerRectangle(i.getBounds(!0)), s = this._outputContext;
          let o;
          typeof i.placeholderFillStyle == "function" ? o = i.placeholderFillStyle(i, s) : o = i.placeholderFillStyle, this._offsetForRotation({ degrees: this.viewer.viewport.getRotation(!0) }), s.fillStyle = o, s.translate(a.x, a.y), s.rotate(Math.PI / 180 * n.degrees), s.translate(-a.x, -a.y), s.fillRect(a.x, a.y, a.width, a.height), this._restoreRotationChanges();
        }
        /**
         * Get the canvas center
         * @private
        ...
        static initShaderProgram(i, n, a) {
          function s(p, m, w) {
            const y = p.createShader(m);
            return p.shaderSource(y, w), p.compileShader(y), p.getShaderParameter(y, p.COMPILE_STATUS) ? y : (e.console.error(
              `An error occurred compiling the shaders: ${p.getShaderInfoLog(y)}`
            ), p.deleteShader(y), null);
          }
          const o = s(i, i.VERTEX_SHADER, n), l = s(i, i.FRAGMENT_SHADER, a), u = i.createProgram();
          return i.attachShader(u, o), i.attachShader(u, l), i.linkProgram(u), i.getProgramParameter(u, i.LINK_STATUS) ? u : (e.console.error(
      ...
      e.Viewport = function(t) {
        ...
        getCenter: function(t) {
          ...
          return t ? r : this.zoomPoint ? (n = this.pixelFromPoint(this.zoomPoint, !0), a = this.getZoom(), s = 1 / a, o = s / this.getAspectRatio(), l = new e.Rect(
            r.x - s / 2,
            r.y - o / 2,
            s,
            o
          ), u = this._pixelFromPoint(this.zoomPoint, l), p = u.minus(n).rotate(-this.getRotation(!0)), m = p.divide(this._containerInnerSize.x * a), i.plus(m)) : i;
        },
        /**
         * @function
         * @param {Boolean} current - Pass true for the current location; defaults to false (target location).
        ...
        _applyBoundaryConstraints: function(t) {
          var r = this.viewportToViewerElementRectangle(t).getBoundingBox(), i = this.viewportToViewerElementRectangle(this._contentBoundsNoRotate).getBoundingBox(), n = !1, a = !1;
          if (!this.wrapHorizontal) {
            var s = r.x + r.width, o = i.x + i.width, l, u, p;
            r.width > i.width ? l = this.visibilityRatio * i.width : l = this.visibilityRatio * r.width, u = i.x - s + l, p = o - r.x - l, l > i.width ? (r.x += (u + p) / 2, n = !0) : p < 0 ? (r.x += p, n = !0) : u > 0 && (r.x += u, n = !0);
          }
          if (!this.wrapVertical) {
            var m = r.y + r.height, w = i.y + i.height, y, T, x;
            r.height > i.height ? y = this.visibilityRatio * i.height : y = this.visibilityRatio * r.height, T = i.y - m + y, x = w - r.y - y, y > i.height ? (r.y += (T + x) / 2, a = !0) : x < 0 ? (r.y += x, a = !0) : T > 0 && (r.y += T, a = !0);
          }
          var E = n || a, P = E ? this.viewerElementToViewportRectangle(r) : t.clone();
          return P.xConstrained = n, P.yConstrained = a, P.constraintApplied = E, P;
        },
        /**
         * @function
         * @private
        ...
        _fitBounds: function(t, r) {
          r = r || {};
          var i = r.immediately || !1, n = r.constraints || !1, a = this.getAspectRatio(), s = t.getCenter(), o = new e.Rect(
            t.x,
            t.y,
            t.width,
            t.height,
          ...
          o.getAspectRatio() >= a ? o.height = o.width / a : o.width = o.height * a, o.x = s.x - o.width / 2, o.y = s.y - o.height / 2;
          var l = 1 / o.width;
          if (i)
            return this.panTo(s, !0), this.zoomTo(l, null, !0), n && this.applyConstraints(!0), this;
          var u = this.getCenter(!0), p = this.getZoom(!0);
          this.panTo(u, !0), this.zoomTo(p, null, !0);
          var m = this.getBounds(), w = this.getZoom();
          ...
          if (n) {
            ...
            this.panTo(u, !0), this.zoomTo(p, null, !0), this.fitBounds(y);
          } else {
            var T = o.rotate(-this.getRotation()), x = T.getTopLeft().times(l).minus(m.getTopLeft().times(w)).divide(l - w);
            this.zoomTo(l, x, i);
          }
          return this;
        },
        ...
        rotateTo: function(t, r, i) {
          ...
          if (this.rotationPivot = r instanceof e.Point && !isNaN(r.x) && !isNaN(r.y) ? r : null, i)
            ...
            var a = e.positiveModulo(this.degreesSpring.current.value, 360), s = e.positiveModulo(t, 360), o = s - a;
            o > 180 ? s -= 360 : o < -180 && (s += 360);
            var l = a - s;
         ...
         */
        resize: function(t, r) {
          var i = this.getBoundsNoRotate(), n = i, a;
          this.containerSize.x = t.x, this.containerSize.y = t.y, this._updateContainerInnerSize(), r && (a = t.x / this.containerSize.x, n.width = i.width * a, n.height = n.width / this.getAspectRatio()), this.viewer && this.viewer.raiseEvent("resize", {
            newContainerSize: t,
            maintain: r
          });
        ...
        _rotateAboutPivot: function(t) {
          ...
          var n = this.degreesSpring.current.value - this._oldDegrees, a = i.rotate(n * -1).times(-1);
        ...
        _adjustCenterSpringsForZoomPoint: function(t) {
          if (this.zoomPoint) {
            ...
            t();
            var i = this.pixelFromPoint(this.zoomPoint, !0), n = i.minus(r), a = this.deltaPointsFromPixels(
              n,
              !0
            );
        ...
        imageToViewportCoordinates: function(t, r) {
          ...
          var a = this._imageToViewportDelta(t, r);
        ...
        imageToViewportRectangle: function(t, r, i, n) {
          var a = t;
          if (a instanceof e.Rect || (a = new e.Rect(t, r, i, n)), this.viewer) {
            ...
            if (s > 1)
              ...
              return o.imageToViewportRectangle(
                t,
                r,
                i,
                n,
          ...
          var l = this.imageToViewportCoordinates(a.x, a.y), u = this._imageToViewportDelta(a.width, a.height);
          return new e.Rect(
            l.x,
            l.y,
            u.x,
        ...
        viewportToImageRectangle: function(t, r, i, n) {
          ...
          if (a instanceof e.Rect || (a = new e.Rect(t, r, i, n)), this.viewer) {
            ...
            if (s > 1)
              ...
              var o = this.viewer.world.getItemAt(0);
              return o.viewportToImageRectangle(
                t,
                r,
                i,
                n,
          ...
          var l = this.viewportToImageCoordinates(a.x, a.y), u = this._viewportToImageDelta(a.width, a.height);
          return new e.Rect(
            l.x,
            l.y,
            u.x,
        ...
        viewportToImageZoom: function(t) {
          ...
          var n = this._contentSizeNoRotate.x, a = this._containerInnerSize.x, s = this._contentBoundsNoRotate.width, o = a / n * s;
          return t * o;
        },
        /**
        ...
        imageToViewportZoom: function(t) {
          ...
          var n = this._contentSizeNoRotate.x, a = this._containerInnerSize.x, s = this._contentBoundsNoRotate.width, o = n / a / s;
          return t * o;
        },
        /**
      ...
      e.TiledImage = function(t) {
        ...
        var a = t.fitBounds;
        delete t.fitBounds;
        var s = t.fitBoundsPlacement || F.Placement.CENTER;
        ...
        delete t.ajaxHeaders, e.extend(!0, this, {
          ...
          springStiffness: this.springStiffness,
          animationTime: this.animationTime
        }), this._updateForScale(), a && this.fitBounds(a, s, !0), this._ownAjaxHeaders = {}, this.setAjaxHeaders(l, !1), this._initialized = !0;
      }, e.extend(
        ...
        /** @lends OpenSeadragon.TiledImage.prototype */
        {
           ...
           */
          update: function(t) {
            let r = this._xSpring.update(), i = this._ySpring.update(), n = this._scaleSpring.update(), a = this._degreesSpring.update(), s = r || i || n || a || this._needsUpdate;
            if (s || t || !this._fullyLoaded) {
              let o = this._updateLevelsForViewport();
              this._setFullyLoaded(o);
            }
          ...
          getClippedBounds: function(t) {
            ...
            if (this._clip) {
              var i = t ? this._worldWidthCurrent : this._worldWidthTarget, n = i / this.source.dimensions.x, a = this._clip.times(n);
              r = new e.Rect(
                r.x + a.x,
                r.y + a.y,
                a.width,
          ...
          getTileBounds: function(t, r, i) {
            var n = this.source.getNumTiles(t), a = (n.x + r % n.x) % n.x, s = (n.y + i % n.y) % n.y, o = this.source.getTileBounds(t, a, s);
            return this.getFlip() && (o.x = Math.max(0, 1 - o.x - o.width)), o.x += (r - a) / n.x, o.y += this._worldHeightCurrent / this._worldWidthCurrent * ((i - s) / n.y), o;
          },
          /**
           ...
           */
          imageToViewportRectangle: function(t, r, i, n, a) {
            var s = t;
            s instanceof e.Rect ? a = r : s = new e.Rect(t, r, i, n);
            var o = this.imageToViewportCoordinates(s.getTopLeft(), a), l = this._imageToViewportDelta(s.width, s.height, a);
            return new e.Rect(
              o.x,
              o.y,
              l.x,
              l.y,
              s.degrees + this.getRotation(a)
            );
          },
          /**
           * Translates from a rectangle which describes a portion of
           ...
           */
          viewportToImageRectangle: function(t, r, i, n, a) {
            var s = t;
            t instanceof e.Rect ? a = r : s = new e.Rect(t, r, i, n);
            var o = this.viewportToImageCoordinates(s.getTopLeft(), a), l = this._viewportToImageDelta(s.width, s.height, a);
            return new e.Rect(
              o.x,
              o.y,
              l.x,
          ...
          windowToImageCoordinates: function(t) {
            var r = t.minus(
              F.getElementPosition(this.viewer.element)
            );
            return this.viewerElementToImageCoordinates(r);
          },
          /**
          ...
          fitBounds: function(t, r, i) {
            ...
            var n = e.Placement.properties[r], a = this.contentAspectX, s = 0, o = 0, l = 1, u = 1;
            if (this._clip && (a = this._clip.getAspectRatio(), l = this._clip.width / this.source.dimensions.x, u = this._clip.height / this.source.dimensions.y, t.getAspectRatio() > a ? (s = this._clip.x / this._clip.height * t.height, o = this._clip.y / this._clip.height * t.height) : (s = this._clip.x / this._clip.width * t.width, o = this._clip.y / this._clip.width * t.width)), t.getAspectRatio() > a) {
              var p = t.height / u, m = 0;
              n.isHorizontallyCentered ? m = (t.width - t.height * a) / 2 : n.isRight && (m = t.width - t.height * a), this.setPosition(
                new e.Point(t.x - s + m, t.y - o),
                i
              ), this.setHeight(p, i);
            } else {
              var w = t.width / l, y = 0;
              n.isVerticallyCentered ? y = (t.height - t.width / a) / 2 : n.isBottom && (y = t.height - t.width / a), this.setPosition(
                new e.Point(t.x - s, t.y - o + y),
                i
              ), this.setWidth(w, i);
            }
          },
          ...
          _updateAjaxHeaders: function(t) {
            if (t === void 0 && (t = !0), e.isPlainObject(this.viewer.ajaxHeaders) ? this.ajaxHeaders = e.extend({}, this.viewer.ajaxHeaders, this._ownAjaxHeaders) : this.ajaxHeaders = this._ownAjaxHeaders, t) {
              ...
              for (var s in this.tilesMatrix) {
                ...
                for (var o in this.tilesMatrix[s]) {
                  i = (r.x + o % r.x) % r.x;
                  for (var l in this.tilesMatrix[s][o])
                    if (n = (r.y + l % r.y) % r.y, a = this.tilesMatrix[s][o][l], a.loadWithAjax = this.loadTilesWithAjax, a.loadWithAjax) {
                      var u = this.source.getTileAjaxHeaders(s, i, n);
                      a.ajaxHeaders = e.extend({}, this.ajaxHeaders, u);
                    } else
                      a.ajaxHeaders = null;
                }
              }
              for (var p = 0; p < this._imageLoader.jobQueue.length; p++) {
                var m = this._imageLoader.jobQueue[p];
          ...
          _updateLevelsForViewport: function() {
            var t = this._getLevelsInterval(), r = t.lowestLevel, i = t.highestLevel, n = [], a = this.getDrawArea(), s = e.now();
            ...
            var o = new Array(i - r + 1);
            for (let B = 0, z = i; z >= r; z--, B++)
              o[B] = z;
            ...
            for (let B = 0; B < o.length; B++) {
              ...
              if (B === o.length - 1 || p >= this.minPixelRatio)
                u = !0;
              else if (!u)
                continue;
              var m = this.viewport.deltaPixelsFromPointsNoRotate(
                this.source.getPixelRatio(z),
                !1
                ...
                !1
              ).x * this._scaleSpring.current.value, y = this.immediateRender ? 1 : w, T = Math.min(1, (p - 0.5) / 0.5), x = y / Math.abs(
                y - m
              ), E = this._updateLevel(
                z,
                T,
              ...
              n = E.bestTiles;
              var P = E.updatedTiles.filter((U) => U.loaded), L = /* @__PURE__ */ (function(U, W, G) {
                return function(K) {
                  return {
                    tile: K,
                    level: U,
              ...
              if (this._tilesToDraw[z] = P.map(L), this._providesCoverage(this.coverage, z))
                break;
            }
            return n && n.length > 0 ? (n.forEach(function(B) {
          ...
          _updateTilesInViewport: function(t) {
            ...
            function s(l) {
              ...
              if (u && u.loaded) {
                ...
                i._isBlending = i._isBlending || p, i._needsDraw = i._needsDraw || p || i._wasBlending;
              }
            }
            let o = 0;
            for (let l = 0; l < t.length; l++) {
              let u = t[l];
              s(u), this._providesCoverage(this.coverage, u.level) && (o = Math.max(o, u.level));
            }
            if (o > 0)
              for (let l in this._tilesToDraw)
                l < o && delete this._tilesToDraw[l];
          },
          /**
           ...
           */
          _blendTile: function(t, r, i, n, a, s, o) {
            let l = 1e3 * this.blendTime, u, p;
            return t.blendStart || (t.blendStart = s), u = s - t.blendStart, p = l ? Math.min(1, u / l) : 1, n === o && (p = 1, u = l), this.alwaysBlend && (p *= a), t.opacity = p, p === 1 && (this._setCoverage(this.coverage, n, r, i, !0), this._hasOpaqueTile = !0), u < l;
          },
          /**
           ...
           */
          _updateLevel: function(t, r, i, n, a, s) {
            var o = n.getBoundingBox().getTopLeft(), l = n.getBoundingBox().getBottomRight();
            ...
            var u = this._getCornerTiles(t, o, l), p = u.topLeft, m = u.bottomRight, w = this.source.getNumTiles(t), y = this.viewport.pixelFromPoint(this.viewport.getCenter());
            this.getFlip() && (m.x += 1, this.wrapHorizontal || (m.x = Math.min(m.x, w.x - 1)));
            for (var T = Math.max(0, (m.x - p.x) * (m.y - p.y)), x = new Array(T), E = 0, P = p.x; P <= m.x; P++)
              for (var L = p.y; L <= m.y; L++) {
                var B;
                if (this.getFlip()) {
                  var z = (w.x + P % w.x) % w.x;
                  B = P + w.x - z - z - 1;
                  ...
                  B = P;
                if (n.intersection(this.getTileBounds(t, B, L)) !== null) {
           ...
           * @param {Number} levelVisibility
           */
          _positionTile: function(t, r, i, n, a) {
            ...
            var o = t.bounds.getSize();
            o.x *= this._scaleSpring.current.value, o.y *= this._scaleSpring.current.value, t.positionedBounds.x = s.x, t.positionedBounds.y = s.y, t.positionedBounds.width = o.x, t.positionedBounds.height = o.y;
            var l = i.pixelFromPointNoRotate(s, !0), u = i.pixelFromPointNoRotate(s, !1), p = i.deltaPixelsFromPointsNoRotate(o, !0), m = i.deltaPixelsFromPointsNoRotate(o, !1), w = u.plus(m.divide(2)), y = n.squaredDistanceTo(w);
            this.viewer.drawer.minimumOverlapRequired(this) && (r || (p = p.plus(new e.Point(1, 1))), t.isRightMost && this.wrapHorizontal && (p.x += 0.75), t.isBottomMost && this.wrapVertical && (p.y += 0.75)), t.position = l, t.size = p, t.squaredDistance = y, t.visibility = a;
          },
          /**
           ...
           */
          _updateTile: function(t, r, i, n, a, s, o, l) {
            var u = this._getTile(
              t,
              r,
              i,
            ...
            var p = u.loaded || u.loading || this._isCovered(this.loadingCoverage, i, t, r);
            if (this._setCoverage(this.loadingCoverage, i, t, r, p), !u.exists)
              return {
                bestTiles: l,
                tile: u
              };
            if (u.loaded && u.opacity === 1 && this._setCoverage(this.coverage, i, t, r, !0), this._positionTile(
              u,
              ...
              if (u.context2D)
                this._setTileLoaded(u);
              else {
                var m = this._tileCache.getImageRecord(u.cacheKey);
                m && this._setTileLoaded(u, m.getData());
              }
            return u.loading ? this._tilesLoading++ : p || (l = this._compareTiles(l, u, this.maxTilesPerFrame)), {
              bestTiles: l,
              tile: u
            };
          },
          ...
          _getCornerTiles: function(t, r, i) {
            var n, a;
            this.wrapHorizontal ? (n = e.positiveModulo(r.x, 1), a = e.positiveModulo(i.x, 1)) : (n = Math.max(0, r.x), a = Math.min(1, i.x));
            var s, o, l = 1 / this.source.aspectRatio;
            this.wrapVertical ? (s = e.positiveModulo(r.y, l), o = e.positiveModulo(i.y, l)) : (s = Math.max(0, r.y), o = Math.min(l, i.y));
            var u = this.source.getTileAtPoint(t, new e.Point(n, s)), p = this.source.getTileAtPoint(t, new e.Point(a, o)), m = this.source.getNumTiles(t);
            return this.wrapHorizontal && (u.x += m.x * Math.floor(r.x), p.x += m.x * Math.floor(i.x)), this.wrapVertical && (u.y += m.y * Math.floor(r.y / l), p.y += m.y * Math.floor(i.y / l)), {
              topLeft: u,
              bottomRight: p
            };
          },
           ...
           */
          _getTile: function(t, r, i, n, a) {
            var s, o, l, u, p, m, w, y, T, x, E = this.tilesMatrix, P = this.source;
            return E[i] || (E[i] = {}), E[i][t] || (E[i][t] = {}), (!E[i][t][r] || !E[i][t][r].flipped != !this.flipped) && (s = (a.x + t % a.x) % a.x, o = (a.y + r % a.y) % a.y, l = this.getTileBounds(i, t, r), u = P.getTileBounds(i, s, o, !0), p = P.tileExists(i, s, o), m = P.getTileUrl(i, s, o), w = P.getTilePostData(i, s, o), this.loadTilesWithAjax ? (y = P.getTileAjaxHeaders(i, s, o), e.isPlainObject(this.ajaxHeaders) && (y = e.extend({}, this.ajaxHeaders, y))) : y = null, T = P.getContext2D ? P.getContext2D(i, s, o) : void 0, x = new e.Tile(
              i,
              t,
              r,
              l,
              ...
              u,
              w,
              P.getTileHashKey(i, s, o, m, y, w)
            ), this.getFlip() ? s === 0 && (x.isRightMost = !0) : s === a.x - 1 && (x.isRightMost = !0), o === a.y - 1 && (x.isBottomMost = !0), x.flipped = this.flipped, E[i][t][r] = x), x = E[i][t][r], x.lastTouchTime = n, x;
          },
          /**
           ...
           */
          _onTileLoad: function(t, r, i, n, a) {
            if (i)
              t.exists = !0;
            else {
            ...
            var s = this, o = function() {
              var l = s.source, u = l.getClosestLevel();
              s._setTileLoaded(t, i, u, a);
            };
            o();
          },
          /**
          ...
          _setTileLoaded: function(t, r, i, n) {
            var a = 0, s = !1, o = this;
            function l() {
              return s && e.console.error("Event 'tile-loaded' argument getCompletionCallback must be called synchronously. Its return value should be called asynchronously."), a++, u;
            }
            function u() {
              a--, a === 0 && (t.loading = !1, t.loaded = !0, t.hasTransparency = o.source.hasTransparency(
                t.context2D,
                t.getUrl(),
                t.ajaxHeaders,
                t.postData
              ), t.context2D || o._tileCache.cacheTile({
                data: r,
                tile: t,
                cutoff: i,
                tiledImage: o
              }), o.viewer.raiseEvent("tile-ready", {
                tile: t,
                tiledImage: o,
                tileRequest: n
              }), o._needsDraw = !0);
           ...
           */
          _setCoverage: function(t, r, i, n, a) {
            if (!t[r]) {
              e.console.warn(
      ...
      r.prototype = {
        ...
        cacheTile: function(i) {
          ...
          var n = i.cutoff || 0, a = this._tilesLoaded.length, s = this._imagesLoaded[i.tile.cacheKey];
          if (s || (i.data || (e.console.error("[TileCache.cacheTile] options.image was renamed to options.data. '.image' attribute has been deprecated and will be removed in the future."), i.data = i.image), e.console.assert(i.data, "[TileCache.cacheTile] options.data is required to create an ImageRecord"), s = this._imagesLoaded[i.tile.cacheKey] = new r({
            ...
            for (var o = null, l = -1, u = null, p, m, w, y, T, x, E = this._tilesLoaded.length - 1; E >= 0; E--)
              if (x = this._tilesLoaded[E], p = x.tile, !(p.level <= n || p.beingDrawn)) {
                if (!o) {
                  o = p, l = E, u = x;
                  continue;
                }
                y = p.lastTouchTime, m = o.lastTouchTime, T = p.level, w = o.level, (y < m || y === m && T > w) && (o = p, l = E, u = x);
              }
            o && l >= 0 && (this._unloadTile(u), a = l);
          }
        ...
        clearTilesFor: function(i) {
          ...
          for (var n, a = 0; a < this._tilesLoaded.length; ++a)
            n = this._tilesLoaded[a], n.tiledImage === i && (this._unloadTile(n), this._tilesLoaded.splice(a, 1), a--);
        },
        // private
        ...
        _unloadTile: function(i) {
          ...
          var n = i.tile, a = i.tiledImage;
          let s = n.getCanvasContext && n.getCanvasContext();
          n.unload(), n.cacheImageRecord = null;
          var o = this._imagesLoaded[n.cacheKey];
          o && (o.removeTile(n), o.getTileCount() || (o.destroy(), delete this._imagesLoaded[n.cacheKey], this._imagesLoadedCount--, s && (s.canvas.width = 0, s.canvas.height = 0, a.viewer.raiseEvent("image-unloaded", {
            context2D: s,
            tile: n
      ...
      e.World = function(t) {
        ...
        /** @lends OpenSeadragon.World.prototype */
        {
          ...
          arrange: function(t) {
            t = t || {};
            var r = t.immediately || !1, i = t.layout || e.DEFAULT_SETTINGS.collectionLayout, n = t.rows || e.DEFAULT_SETTINGS.collectionRows, a = t.columns || e.DEFAULT_SETTINGS.collectionColumns, s = t.tileSize || e.DEFAULT_SETTINGS.collectionTileSize, o = t.tileMargin || e.DEFAULT_SETTINGS.collectionTileMargin, l = s + o, u;
            !t.rows && a ? u = a : u = Math.ceil(this._items.length / n);
            var p = 0, m = 0, w, y, T, x, E;
            this.setAutoRefigureSizes(!1);
            for (var P = 0; P < this._items.length; P++)
              P && P % u === 0 && (i === "horizontal" ? (m += l, p = 0) : (p += l, m = 0)), w = this._items[P], y = w.getBounds(), y.width > y.height ? T = s : T = s * (y.width / y.height), x = T * (y.height / y.width), E = new e.Point(
                p + (s - T) / 2,
                m + (s - x) / 2
              ), w.setPosition(E, r), w.setWidth(T, r), i === "horizontal" ? p += l : m += l;
          ...
          _figureSizes: function() {
            ...
            if (!this._items.length)
              ...
              var n = this._items[0], a = n.getBounds();
              this._contentFactor = n.getContentSize().x / a.width;
              for (var s = n.getClippedBounds().getBoundingBox(), o = s.x, l = s.y, u = s.x + s.width, p = s.y + s.height, m = 1; m < this._items.length; m++)
                n = this._items[m], a = n.getBounds(), this._contentFactor = Math.max(
                  this._contentFactor,
                  n.getContentSize().x / a.width
                ), s = n.getClippedBounds().getBoundingBox(), o = Math.min(o, s.x), l = Math.min(l, s.y), u = Math.max(u, s.x + s.width), p = Math.max(p, s.y + s.height);
              this._homeBounds = new e.Rect(o, l, u - o, p - l), this._contentSize = new e.Point(
...
var be = Oe();
const Ae = /* @__PURE__ */ Fe(be), Me = /* @__PURE__ */ De({
  __proto__: null,
  default: Ae
}, [be]);
export {
