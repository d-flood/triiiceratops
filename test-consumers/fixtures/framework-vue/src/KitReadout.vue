...
import { selectCanvasId, testHandleRef } from './store.js';

const canvasId = useViewerSelector(testHandleRef, selectCanvasId);
</script>

<template>
    <span data-testid="kit-canvas">{{ canvasId ?? 'none' }}</span>
</template>
