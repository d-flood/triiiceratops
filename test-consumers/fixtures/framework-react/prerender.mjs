// Render the server route with `react-dom/server` in plain Node and inject the
// markup into the built `dist/ssr.html`, exactly as a server-rendering host
...
// `triiiceratops/react` neither reaches for them nor registers anything.
