<script lang="ts">
    ...
    import { Button, Select, TextInput, Tooltip } from '../lib/components/ui';

    import { language } from '../lib/state/i18n.svelte';
    import type { BuiltInTheme } from '../lib/theme/types';
    import { manifestsState } from '../lib/state/manifests.svelte';
    import { locales, setLocale } from '../lib/paraglide/runtime.js';
    import { getCanvasLabel } from '../lib/utils/canvasLabels';
    // Canvases are raw IIIF JSON: `id` in v3, `@id` in v2.
    import { getCanvasId } from '../lib/utils/iiifIds';
