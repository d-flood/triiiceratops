...
describe('reportImageDownloadError', () => {
    it('surfaces a download failure on the bubbling, composed `pluginerror` channel', () => {
        ...
        const retry = vi.fn();
        reportImageDownloadError(panel, cause, retry);
