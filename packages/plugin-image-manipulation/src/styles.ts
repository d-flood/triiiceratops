...
import flyoutCss from './flyout.css?raw';

/**
 * The plugin's package-owned global CSS and its style-service install id. What
 * the rules do and why they are global rather than Svelte-scoped is documented
 * in `flyout.css` beside them.
 */
export const { STYLES, STYLE_ID } = definePluginStyles(flyoutCss, 'flyout');
